...
//		System.out.println(obj.getInt("client"));
		...
		if (method.equals("1")) {
			...
			String accountSid="f9d736456bb9ce1af49d35892571ebc9";
			String token="0fed8e2eeae25f1fdfc5bb9e3f9e2688";
			String appId="08d4df5ba638417e8263699f44e016da";
			String templateId="38204";
			String to="18708150883";
			String para="0890";
