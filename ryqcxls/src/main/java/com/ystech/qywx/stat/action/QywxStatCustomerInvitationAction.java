 ...
 *
 */
@Component("qywxStatCustomerInvitationAction")
@Scope("prototype")
public class QywxStatCustomerInvitationAction extends BaseController{
	...
	public void ajaxCarCount(){
		...
		try {
			...
			buffer.append("<tr>");
			buffer.append("<td colspan='2'>合计</td>");
			buffer.append("<td>"+count+"</td>");
			buffer.append("<td>100%</td>");
			buffer.append("</table>");
