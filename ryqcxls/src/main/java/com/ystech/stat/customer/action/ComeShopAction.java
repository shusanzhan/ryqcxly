...
@Component("comeShopAction")
@Scope("prototype")
public class ComeShopAction extends BaseController{
	...
	public String queryComeShopList() {
		...
		try {
			...
			//销售顾问-来店客户车型统计
			List<ComeShopUser> comeShopUsers = comeShopManageImpl.queryComeShopUser(beginDate, endDate, enterprise, type, dateType);
			Map<ComeShopUser, List<CarSerCount>> mapComeShopUserCarSeriys = comeShopManageImpl.queryComeShopUserCarSeriy(comeShopUsers, type, enterprise, beginDate, endDate, dateType);
			...
			//总销售顾问-来店客户车型统计
			List<ComeShopUser> comeShopUserAlls = comeShopManageImpl.queryComeShopUserAll(beginDate, endDate, enterprise, type, dateType);
			Map<ComeShopUser, List<CarSerCount>> mapComeShopUserCarSeriyAlls = comeShopManageImpl.queryComeShopUserCarSeriyAll(comeShopUserAlls, type, enterprise, beginDate, endDate, dateType);
