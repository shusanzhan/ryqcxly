...
<a href="javascript:void(-1);" onclick="window.location.href='${ctx}/school/queryList'">奇瑞汽车免费午餐公益活动</a>-
</div>
<div class="line"></div>
<div class="frmContent">
	...
	<form action="" name="frmId" id="frmId"  target="_self">
		...
		<input type="hidden" name="school.dbid" id="dbid" value="${school.dbid }">
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				<td class="formTableTdLeft">标题:&nbsp;</td>
				<td ><input type="text" name="school.title" id="title"	value="${school.title }" class="largeX text" title="名称" placeholder="请输入标题"	checkType="string,1,30" tip="标题不能为空"><span style="color: red;">*</span>不能超过30个字</td>
			</tr>
				<tr height="42">
				<td class="formTableTdLeft">活动简绍：&nbsp;</td>
				<td >
					<textarea  name="school.intro" id="intro" style="margin: 5px;height: 80px;width: 270px;"	 class="largeX text" title="赠送积分量" placeholder="请输赠送积分量"	checkType="integer,1,50000" tip="赠送积分量不能为空">${school.intro }
					</textarea>
				...
				<td >
					<textarea  name="school.content" id="content" style="margin: 5px;height: 80px;width: 270px;"	 class="largeX text" title="赠送积分量" placeholder="请输赠送积分量"	checkType="integer,1,50000" tip="赠送积分量不能为空">
						${school.content }
					</textarea>
				<span style="color: red;">*</span></td>
			</tr>
	...
	<div class="formButton">
		...
		<a href="javascript:void(-1)"  onclick="submitAjaxForm('frmId','${ctx}/saleActivity/saveSchool')" class="but butSave">保存</a> 
	</div>
	</div>
</body>
