...
<div class="listOperate">
	<div class="operate">
  	...
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm" action="${ctx}/agentCompany/queryList" method="post">
	...
	<tbody>
		<c:forEach items="${page.result }" var="agentCompany">
			...
			<tr>
				...
				<td >
					<a style="color:#2b7dbc " href="${ctx }/agentCompany/agentFile?dbid=${agentCompany.dbid}&type=1" onclick="">
				...
				<td style="text-align: center;">
					<a href="javascript:void(-1)" class="aedit" onclick="$.utile.deleteById('${ctx}/agentCompany/delete?dbids=${agentCompany.dbid}','searchPageForm')" title="删除">删除</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
