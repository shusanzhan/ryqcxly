...
<table class="tableContent" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#e5e5e5 ;">
		...
		<td width="38%" align="left">
			...
			(
				<c:if test="${agent.sex=='男' }">
					<span style="color: #56a845">${agent.sex }</span>
				</c:if>
				<c:if test="${agent.sex=='女' }">
					<span style="color: #ff6700">${agent.sex }</span>
				</c:if>
			)
		</td>
	...
	<tr>
		<td class="formTableTdLeft" align="right" width="12%">推荐我店客户：</td>
		<td width="38%" align="left">
			<span style="color: red;font-size: 16px;">${agentCompany.agentNum }</span>
		</td>
		<td class="formTableTdLeft" width="12%" align="right">推荐我店成功客户：</td>
		<td width="38%" align="left">
			<span style="color: green;font-size: 16px;">${agentCompany.successNum }</span>
		</td>
	</tr>
	<tr>
		<td class="formTableTdLeft" align="right" width="12%">推荐总客户：</td>
		<td width="38%" align="left">
			<span style="color: red;font-size: 16px;">${agent.agentNum }</span>
		</td>
		<td class="formTableTdLeft" width="12%" align="right">推荐总成功客户：</td>
		<td width="38%" align="left">
			<span style="color: green;font-size: 16px;">${agent.agentSuccessNum }</span>
		</td>
	</tr>
</table>
	...
	<div style="margin: 5px 12px;border-buttom:1px solid rgb( 222, 222, 222 ); margin-top: 30px;">
		<ul class="nav nav-tabs" role="tablist">
		  ...
		  <c:if test="${param.type==2 }" var="sta">
		  	<li class="active">
		  		<a href="#installItem" role="tab" data-toggle="tab">推荐客户（本店）</a>
		  	</li>
		  </c:if>
		  <c:if test="${sta==false }">
		  	<li><a href="#installItem" role="tab" data-toggle="tab">推荐客户（本店）</a></li>
		  </c:if>
		   <c:if test="${param.type==3 }" var="sta">
		  	<li class="active"><a href="#carTransfer" role="tab" data-toggle="tab">历史推荐客户</a></li>
		  </c:if>
		  <c:if test="${sta==false }">
		  	<li><a href="#carTransfer" role="tab" data-toggle="tab">历史推荐客户</a></li>
		  </c:if>
		</ul>
		<!-- Tab panes -->
			  ...
			  <div class="tab-pane" id="factoryOrder" >
		  		...
		  		<table class="tableContent" border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;padding: 12px">
					...
					<tr>
						...
						<td class="formTableTdLeft" width="12%" align="right">邮箱：</td>
						<td width="38%" align="left">
							${agent.email }
						</td>
					</tr>
					<tr>
						<td class="formTableTdLeft" align="right" width="12%">银行：</td>
						<td width="38%" align="left">
							${agent.bank }
						</td>
						<td class="formTableTdLeft" width="12%" align="right">银行账号：</td>
						<td width="38%" align="left">
								${agent.bankNo }
						</td>
					</tr>
					<tr>
						<td class="formTableTdLeft" align="right" width="12%">生日：</td>
						<td width="38%" align="left">
							${agent.birthday }
						</td>
					...
					<tr>
							...
							<td class="formTableTdLeft" align="right" width="12%">审批时间：</td>
							<td width="38%" align="left">
								${agent.approveDate }
							</td>
						</tr>
						<tr>
							<td class="formTableTdLeft" align="right" width="12%">审批人：</td>
							<td width="38%" align="left">
								${agent.approvePerson }
							</td>
						</tr>
