...
<div class="listOperate">
	<div class="operate">
		<%-- <a class="but butSave" href="javascript:void(-1);" onclick="window.location.href='${ctx }/recommendCustomer/exportExcel?type=2'">导出EXCEL</a> --%>
   </div>
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm" action="${ctx}/recommendCustomer/queryBigAreaList" method="post">
		...
		<table  cellpadding="0" cellspacing="0" class="searchTable">
			<tr>
                 ...
                 <td>
                 	<select id="approvalStatus" name="approvalStatus"  class="text small" onchange="$('#searchPageForm')[0].submit()">
						<option value="">请选择...</option>
               ...
               <tr>
				...
				<td style="width: 60px;"><div href="javascript:void(-1)" onclick="$('#searchPageForm')[0].submit()" class="searchIcon"></div></td>
				<td>
	...
	<tbody>
		<c:forEach items="${page.result }" var="recommentCustomer">
			<tr>
				...
				<td>
					<a href="${ctx }/recommendCustomer/agentFile?agentId=${recommentCustomer.agent.dbid}&type=1" style="color: #2b7dbc">
				...
				<td>${recommentCustomer.company.name }</td>
				<td>
