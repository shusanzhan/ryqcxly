...
<div class="listOperate">
	<div class="operate">
		<%-- <a class="but button" href="${ctx }/recommentCustomer/add?parentMenu=1">登记客户</a> --%>
   </div>
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm" action="${ctx}/recommendCustomer/queryCompanySalerList" method="post">
	...
	<tbody>
		<c:forEach items="${page.result }" var="recommentCustomer">
			<tr>
				...
				<td>
						${recommentCustomer.recommendDate }
				</td>
				<td>
				...
				<td style="text-align: center;">
					<c:if test="${recommentCustomer.customerStatus==1}">
						<a href="${ctx }/recommendCustomer/toCustomer?dbid=${recommentCustomer.dbid}" class="aedit" onclick="">转为登记客户</a>
					</c:if>
					<c:if test="${recommentCustomer.customerStatus==2}">
						<span style="color: green;">已登记...</span>
					</c:if>
