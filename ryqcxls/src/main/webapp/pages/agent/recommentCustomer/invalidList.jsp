...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="">无效客户</a>
</div>
 <!--location end-->
<div class="line"></div>
<div class="listOperate">
	<div class="operate">
		 ...
		 <a class="but butCancle" href="javascript:void(-1)" onclick="$.utile.deleteIds('${ctx }/recommendCustomer/delete','searchPageForm')">删除</a>
   </div>
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm" action="${ctx}/recommendCustomer/queryInvalidList" method="post">
		...
		<c:forEach items="${page.result }" var="recommentCustomer">
			<tr>
				...
				<td>
					...
					<c:if test="${recommentCustomer.approvalStatus==3}">
						<span style="color:red;">客户无效</span>
					</c:if>
				</td>
				<td style="text-align: center;">
					<a href="javascript:void(-1)" style="color: #2b7dbc"  class="aedit" onclick="$.utile.deleteById('${ctx}/recommendCustomer/delete?dbids=${recommentCustomer.dbid}','searchPageForm')" title="删除">删除</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
