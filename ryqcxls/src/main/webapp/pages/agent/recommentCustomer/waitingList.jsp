...
<div class="listOperate">
	<div class="operate">
  	...
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm" action="${ctx}/recommendCustomer/queryWaitingList" method="post">
...
<table width="100%" border="0" class="mainTable" cellpadding="0" cellspacing="0">
	<thead class="TableHeader">
		<tr>
			...
			<td class="span1">审核</td>
			<td class="span1">销售顾问分配状态</td>
			<td class="span1">交易状态</td>
	...
	<tbody>
		<c:forEach items="${page.result }" var="recommentCustomer">
			<tr>
				...
				<td style="text-align: center;">
					<a href="javascript:void(-1)" style="color: #2b7dbc"  class="aedit" onclick="$.utile.openDialog('${ctx }/recommendCustomer/outFlow?dbid=${recommentCustomer.dbid}&currentPage=${page.currentPageNo}&pageSize=${page.pageSize }','客户无效登记',720,400)" title="客户无效">客户无效</a>
					|
					<a href="#" class="aedit" style="color: #2b7dbc" onclick="$.utile.openDialog('${ctx }/recommendCustomer/distriCompnay?dbid=${recommentCustomer.dbid}&currentPage=${page.currentPageNo}&pageSize=${page.pageSize }&type=1','分配客户',720,400)">分配客户</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
