...
<div class="frmContent">
	<form class="form-horizontal" method="post" action="" 	name="frmId" id="frmId" target="_parent">
		<input type="hidden" value="${backGroundMusic.dbid }" id="dbid" name="backGroundMusic.dbid">
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
				<tr id="logoDiv">
					<td class="formTableTdLeft">上传MP3：</td>
					<td>
						<input type="hidden" name="backGroundMusic.url" id="fileUpload" readonly="readonly"	value="${backGroundMusic.url }">
						<div id="div1" >
				...
				<tr style="height: 50px;">
					...
					<td>
						<textarea class="largeX text" name="backGroundMusic.note" rows="5" style="height: 50px;"	id="note" >${backGroundMusic.note }</textarea>
					</td>
				</tr>
		</table>
	</form>
	<div class="formButton">
			<a href="javascript:void()"	onclick="$.utile.submitForm('frmId','${ctx}/backGroundMusic/save')"	class="but butSave">保&nbsp;&nbsp;存</a> 
