...
<div class="listOperate">
	<div class="operate">
  	...
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/factoryOrder/queryInstallList" method="post" >
...
<table width="100%" border="0" class="mainTable" cellpadding="0" cellspacing="0">
	...
	<tbody>
		...
		<tr >
			...
			<td style="text-align: center;">
			<c:if test="${factoryOrder.carStatus==2||factoryOrder.carStatus==3 }">
