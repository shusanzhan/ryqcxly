...
<div class="listOperate">
	<div class="operate">
  	...
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/factoryOrder/queryStock" method="post" >
...
<table width="100%" border="0" class="mainTable" cellpadding="0" cellspacing="0">
	<thead>
		<tr>
			...
			<td style="width:40px;">预定状态</td>
			<td style="width:40px;">车辆状态</td>
		...
		<tr >
			...
			<td>
				<c:if test="${factoryOrder.reserveStatus==2 }">
					...
					<a href="${ctx }/factoryOrder/factoryOrderDetail?dbid=${factoryOrder.dbid}&vinCode=${factoryOrder.vinCode }&type=6" class="" style="color: #46A0DE;"><span style="color: green;">查看订单</span></a>
				</c:if>
				<c:if test="${factoryOrder.reserveStatus==3 }">
					<span style="color: red;">已预订</span>
					<a href="${ctx }/factoryOrder/factoryOrderDetail?dbid=${factoryOrder.dbid}&vinCode=${factoryOrder.vinCode }&type=7" class="" style="color: #46A0DE;"><span style="color: green;">查看订单</span></a>
				</c:if>
				<c:if test="${factoryOrder.reserveStatus==1 }">
					<span style="color: green;">未预定</span>
				</c:if>
			</td>
			<td>
