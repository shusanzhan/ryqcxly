...
<body class="bodycolor">
	...
	<form action="" name="frmId" id="frmId" style="margin-bottom: 40px;" target="_parent">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;margin-top: 20px;">
			<tbody  >
				...
				<tr>
					<td class="formTableTdLeft">退车原因:&nbsp;</td>
					<td colspan="3">
						<textarea  name="note" id="note" class="textarea largeXXX text" style="height: 120px;width: 540px;" title="" checkType="string,2" placeholder="请填写退车原因" tip="请填写一点备注吧"></textarea>	
	...
	<div class="formButton">
		<a id="saveButton" href="javascript:void(-1)"	onclick="$.utile.submitAjaxForm('frmId','${ctx}/orderBuySaler/saveApply')"	class="but butSave">申请退车</a>
