...
<form action="" id="frmId" name="frmId" method="post">
	...
	<div class="frmTitle" onclick="showOrHiden('contactTable')">结算单</div>
		...
		<div class="frmTitle" onclick="showOrHiden('contactTable')">收款确认</div>
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;margin-top: 12px">
				<tr height="32">
				<td class="formTableTdLeft">收款确认:&nbsp;</td>
				<td colspan="3">
...
<div class="formButton">
	<a id="submit" class="but butSave" href="javascript:void(-1)" onclick="$('#type').val(1);$.utile.submitAjaxForm('frmId','${ctx}/orderBuySalerExpress/saveAccPay')">
		确认收款
	</a>
	<a id="submit" class="but butSave" href="javascript:void(-1)" onclick="$('#type').val(2);$.utile.submitAjaxForm('frmId','${ctx}/orderBuySalerExpress/saveAccPay')">
		收款并打印
	</a>
