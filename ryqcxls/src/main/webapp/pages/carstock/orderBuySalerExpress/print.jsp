...
$().ready(function() {
	...
	$print.click(function() {
		 var no="${orderBuySalerExpress.expressNo}";
		if(null==no||no==''){
...
function createNo(){
	$.post('${ctx }/orderBuySalerExpress/createNo?dbid=${orderBuySalerExpress.dbid}',{},function (data){
    ...
    <tbody>
       <tr height="40" style=";">
        ...
        <tr height="24" style=";height:24px">
            ...
            <td align="center" colspan="1" style="border-left:none" class="selectTdClass">
                结算金额
            </td>
            ...
            <td align="center" colspan="3" style="border-left:none" class="selectTdClass">
       		...
       		<tr height="24" style=";height:24px">
	            ...
	            <td style="border-top:none;border-left:none" class="selectTdClass">${orderBuySalerExpress.carStatementPrice }</td>
	            <td style="border-top:none;border-left:none" class="selectTdClass">${orderBuySalerExpress.carBuyPrice }</td>
       		...
       		<tr height="24" style=";height:24px">
	            ...
	            <td style="border-top:none;border-left:none" class="selectTdClass">${orderBuySalerExpress.decorePrice }</td>
	            <td style="border-top:none;border-left:none" class="selectTdClass">${orderBuySalerExpress.decoreCostPrice }</td>
       		...
       		<tr height="24" style=";height:24px">
	            ...
	            <td style="border-top:none;border-left:none" class="selectTdClass">${orderBuySalerExpress.finPrice }</td>
	            <td style="border-top:none;border-left:none" class="selectTdClass">${orderBuySalerExpress.finCostPrice }</td>
       		...
       		<tr height="24" style=";height:24px">
	            ...
	            <td style="border-top:none;border-left:none" class="selectTdClass">${orderBuySalerExpress.otherPrice }</td>
	            <td style="border-top:none;border-left:none" class="selectTdClass">${orderBuySalerExpress.otherCostPrice }</td>
       ...
       <c:if test="${param.type==1 }">
	        <tr height="24" style=";height:24px">
	            ...
	            <td colspan="1" style="border-left:none" class="selectTdClass">
	            	<fmt:formatNumber value="${orderBuySalerExpress.totalCostPrice }" pattern="￥###,###.00"></fmt:formatNumber>
	            </td>
	            <td style="border-top:none;border-left:none" class="selectTdClass">
	                利润
	            </td>
	            <td colspan="2" style="border-left:none" class="selectTdClass">
	            	<fmt:formatNumber value="${orderBuySalerExpress.profitPrice }" pattern="￥###,###.00"></fmt:formatNumber>
	            </td>
	        </tr>
       </c:if>
       <c:if test="${empty(param.type) }">
         ...
         <tr height="35" style=";height:35px" class="noneLine">
            ...
            <td align="left" colspan="2"> 制表：${orderBuySalerExpress.creator }</td>
            <td colspan="2"></td>
            <td>
                收银：
            </td>
