...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="">待收款</a>
</div>
 <!--location end-->
<div class="line"></div>
<div class="listOperate">
	<div class="operate">
  	...
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/orderBuySalerExpress/querySaleList" method="post" >
...
<table width="100%" border="0" class="mainTable" cellpadding="0" cellspacing="0">
	...
	<tbody>
		...
		<tr >
			...
			<td style="text-align: center;">
				<c:if test="${orderBuySalerExpress.approvalStatus!=2 }">
					<a href="${ctx}/orderBuySalerExpress/edit?orderBuySalerDbid=${orderBuySaler.dbid}&type=3" class="aedit" >修改单据</a>|
				</c:if>
				<c:if test="${orderBuySalerExpress.approvalStatus==2 }">
					<c:if test="${orderBuySalerExpress.payStatus==2 }">
						<a href="${ctx}/orderBuySalerExpress/accPay?orderBuySalerDbid=${orderBuySaler.dbid}" class="aedit" >确认收款</a>|
					</c:if>
				</c:if>
				<c:if test="${orderBuySalerExpress.approvalStatus==2 }">
					<a href="${ctx}/orderBuySalerExpress/print?orderBuySalerDbid=${orderBuySaler.dbid}&type=1" class="aedit" >打印</a>|
				</c:if>
				<a href="${ctx}/orderBuySalerExpress/view?orderBuySalerDbid=${orderBuySaler.dbid}&type=1" class="aedit" >查看明细</a>
			</td>
		</tr>
		</c:forEach>
	</tbody>
