					...
					<div class="page-content-area">
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter green">查看库单</h3>
										<p>

											<a href="${ctx }/outboundOrder/printOutStock?customerId=${param.customerId}&view=2" class="btn btn-app btn-success" style="font-size: 16px;">
												<i class="ace-icon glyphicon glyphicon-print bigger-230"></i>
												查看出库单
											</a>

											<a href="${ctx }/outboundOrder/printDecore?customerId=${param.customerId}&view=2" class="btn btn-app btn-warning" style="font-size: 15px;">
												<i class="ace-icon glyphicon glyphicon-print bigger-230"></i>
												查看附加通知
											</a>
											<a href="${ctx }/outboundOrder/printGiveDecore?customerId=${param.customerId}&view=2" class="btn btn-app btn-warning" style="font-size: 16px;">
