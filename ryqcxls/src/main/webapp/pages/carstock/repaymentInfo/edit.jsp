...
<body class="bodycolor">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;margin-top: 20px;">
			<tbody  >
				...
				<tr height="42">
					...
					<td colspan="3">
						<textarea  name="repaymentInfo.note" id="note"	 class="textarea largeXXX text" title="" >${repaymentInfo.note }</textarea>	
					</td>
				</tr>
			</tbody>
		</table>
	...
	<div class="formButton">
		<a id="saveButton" href="javascript:void(-1)"	onclick="$.utile.submitAjaxForm('frmId','${ctx}/carRepaymentManagement/saveSingleRegister')"	class="but butSave">保&nbsp;&nbsp;存</a> 
