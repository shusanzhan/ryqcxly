   ...
   <form class="form-horizontal" method="post" action="" name="frmId" id="frmId">
	...
	<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 98%;">
			...
			<tr >
				...
				<td class="formTableTdLeft" style="font-size: 16px;" colspan="2"><a href="javascript:void(-1)" class="aedit" onclick="moreInfo()" id="moreButtom">继续完善资料</a></td>
			</tr>
	</table>
	<div style="display: none;" id="moreInfo">
	<div class="frmTitle" onclick="showOrHiden('contactTable')">继续完善客户资料</div>
	<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 98%;" id="contactTable">
			<tr>
...
<div class="formButton">
		<a href="javascript:void(-1)" id="sbmId"	onclick="if(validateFrm()){$.utile.submitAjaxForm('frmId','${ctx}/customer/saveComeShopingRecordSuccess')}"	class="but butSave">保存继续完成订单</a> 
...
function moreInfo(){
	if($('#moreInfo').css('display')=='none'){
		$("#moreInfo").show();
		$("#moreButtom").text("取消完善资料")
	}else{
		$("#moreInfo").hide();
		$("#moreButtom").text("继续完善资料")
	}
}
/**
 * 通过生日 获取 年龄
