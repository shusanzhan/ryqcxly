...
<div class="formButton">
		<a href="javascript:void(-1)" id="sbmId"	onclick="if(validateFrm()){$.utile.submitAjaxForm('frmId','${ctx}/custCustomer/saveComeShopingRecordSuccess')}"	class="but butSave">保存继续完成订单</a> 
