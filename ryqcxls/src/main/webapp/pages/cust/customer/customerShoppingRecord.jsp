...
<div class="listOperate" style="margin-bottom: 1px;">
	<div class="operate">
		...
		<a class="but button" href="javascript:void();" onclick="operator('${ctx }/custCustomer/satisfactionAssessment')">满意度评估表</a>
		<a class="but button" href="javascript:void();" onclick="operator('${ctx }/custCustomer/negotiationsQuote')">商谈报价单</a>
	   <div class="clear"></div>
   </div>
	...
	function comeShopeRecord(customerId){
		top.art.dialog({
		    ...
		    ok: function () {
	    		...
	    		var url='${ctx}/custCustomer/comeShopRecord?customerId='+customerId+'&comeShopeStatus='+selectvalue+"&redirectType=1";
