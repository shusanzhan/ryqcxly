...
<div class="listOperate" style="margin-bottom: 1px;">
	<div class="operate">
		<!-- <a class="but button" href="javascript:void();" onclick="sendMms()">发送短信</a> -->
		<a class="but button" href="javascript:void();" onclick="operator('${ctx }/customer/testDriveAgreement')">试乘试驾协议书</a>
		<a class="but button" href="javascript:void();" onclick="operator('${ctx }/customer/satisfactionAssessment')">满意度评估表</a>
		<a class="but button" href="javascript:void();" onclick="operator('${ctx }/customer/negotiationsQuote')">商谈报价单</a>
	   <div class="clear"></div>
   </div>
   <div class="seracrhOperate" >
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/customer/customerShoppingRecordqueryList" method="post" >
	...
	function comeShopeRecord(customerId){
		top.art.dialog({
		    ...
		    ok: function () {
	    		...
	    		var url='${ctx}/customer/comeShopRecord?customerId='+customerId+'&comeShopeStatus='+selectvalue+"&redirectType=1";
