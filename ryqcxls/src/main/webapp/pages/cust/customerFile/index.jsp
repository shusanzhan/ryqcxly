					...
					<div class="page-content-area">
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter green">填写客户档案（${customer.customerPidBookingRecord.brand.name }）</h3>
										<p>
											<c:if test="${empty(customerFile) }">
												<a href="${ctx }/customerFile/edit?customerId=${customerId}&custType=1" class="btn btn-app btn-primary" style="font-size: 16px;">
													<i class="ace-icon fa fa-pencil-square-o bigger-230"></i>
													私人客户
												</a>
	
												<a href="${ctx }/customerFile/edit?customerId=${customerId}&custType=2" class="btn btn-app btn-success" style="font-size: 16px;">
													<i class="ace-icon fa fa-pencil-square-o bigger-230"></i>
													单位客户
												</a>
											</c:if>
											<c:if test="${!empty(customerFile) }">
												<c:if test="${customerFile.custType==1 }">
													<a href="${ctx }/customerFile/edit?customerId=${customerId}&custType=1" class="btn btn-app btn-primary" style="font-size: 16px;">
														<i class="ace-icon fa fa-pencil-square-o bigger-230"></i>
														私人客户
													</a>
												</c:if>
												<c:if test="${customerFile.custType==2 }">
													<a href="${ctx }/customerFile/edit?customerId=${customerId}&custType=2" class="btn btn-app btn-primary" style="font-size: 16px;">
														<i class="ace-icon fa fa-pencil-square-o bigger-230"></i>
														单位客户
													</a>
												</c:if>
												<a href="${ctx }/customerFile/print?customerId=${customerId}" class="btn btn-app btn-success" style="font-size: 16px;">
