...
<table cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px;width: 100%">
		<tr height="50">
			<td class="noLine" style="text-align: center;font-size: 18px;font-weight: bold;border: 0px solid #000000;width: 160px;">凯翼客户档案登记表（单位） </td>
		</tr>
	</table>
<div id="frmContent" class="frmContent">
   ...
   <input type="hidden" value="2" id="custType" name="customerFile.custType">
   <div id="baseInfor">
   	   ...
   	   <div class="frmTitle" onclick="showOrHiden('contactTable')">客户基本信息</div>
   	    <table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 98%;">
			<tr>
				...
				<td>
					<input  type="text" class="largeX text"  name="customerFile.depName" id="depName"  value="${customerFile.depName }" checkType="string,1" tip="请输入单位名称！"/>
					<span style="color: red;">*</span>
				</td>
		</tr>
			<tr>
				 <td class="formTableTdLeft" style="font-size: 11px;">企业代码证号码：</td>
				<td>
					<c:if test="${empty(customerFile) }">
						<input  type="text" class="largeX text"  name="customerFile.depNo" id="name"  value="${customer.icard}" checkType="string,1" tip="请输入企业代码证号码！"/>
					</c:if>
					<c:if test="${!empty(customerFile) }">
						<input  type="text" class="largeX text"  name="customerFile.depNo" id="name"  value="${customerFile.depNo }" checkType="string,1" tip="请输入企业代码证号码！"/>
					</c:if>
					<span style="color: red;">*</span>
				</td> 
				 <td class="formTableTdLeft" style="font-size: 11px;">单位性质：</td>
				<td>
					<select id="depNatureId" name="depNatureId" class="largeX text" checkType="integer,1"  tip="请选择单位性质">
						<option value="">请选择...</option>
						<c:forEach var="depNature" items="${depNatures }">
							<option value="${depNature.dbid }" ${customerFile.depNature.dbid==depNature.dbid?'selected="selected"':'' } >${depNature.name }</option>
						</c:forEach>
					</select>
					<span style="color: red;">*</span>
				</td> 
	   ...
	   <table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 98%;">
			...
			<c:if test="${customerFile.residencePermit==2 }">
	   		...
	   		<tr>
				...
				<td>
						<input type="text" class="largeX text"  name="customerFile.contactPerson" id="contactPerson"  value="${customerFile.contactPerson }" checkType="string,1"  tip="请输入联系人"/>
					<span style="color: red;">*</span>
				</td>
	   ...
	   <table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 98%;">
			...
			<tr>
				...
				<td>
						<input type="text" readonly="readonly" class="largeX text"  name="invoicePrice" id="price"  value="${outboundOrder.invoicePrice }" checkType="integer,10000," placeholder="请输入购车价格"  tip="购车价格不能为空,请输入购车价格！"/>
						<span style="color: red;">*</span>
				</td>
			...
			<tr>
				...
				<td>
					...
					<td class="formTableTdLeft">上牌日期：</td>
					<td>
						<input name="customerFile.carNoDate"  class="large text" id="carNoDate" title="上牌日期"  onfocus="WdatePicker()" value="${customerFile.carNoDate }" ></input>
				</td>
			</tr>
		</table>
		<table id="artBuyCarExperise" cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px;width: 100%;display: none;">
			<tr>
				...
				<tr>
					<td class="formTableTdLeft">上牌日期：</td>
					<td>
						<input name="customerFile.carNoDate"  class="large text" id="carNoDate" title="原车VIN"  value="${customerFile.carNoDate }" ></input>
					</td>
				</tr>
		</table>
	</div>
