...
<table cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px;width: 100%">
		<tr height="50">
			<td class="noLine" style="text-align: center;font-size: 18px;font-weight: bold;border: 0px solid #000000;width: 160px;">表1—凯翼客户档案登记表（个人） </td>
		</tr>
	</table>
...
<%-- 	   		<tr>
	   		...
	   		<tr>
					<td class="formTableTdLeft">服务微信号关注时间：</td>
					<td>
						<input type="text"   class="largeX text" name="email" id="email" value="${customer.email }" checkType="string,1" canEmpty="Y" tip="请输入服务微信号关注时间！可以为空">
					</td>
					
					<td class="formTableTdLeft">微信昵称+会员名：</td>
					<td>
						<input type="text"   class="largeX text" name="qq" id="qq" value="${customer.qq }" checkType="string,1" canEmpty="Y" tip="请输入微信昵称+会员名！可以为空">
					</td>
			</tr>
	   ...
	   <table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 98%;">
			...
			<tr>
				...
				<td>
						<input type="text" readonly="readonly" class="largeX text"  name="invoicePrice" id="price"  value="${outboundOrder.invoicePrice }" checkType="float" placeholder="请输入购车价格"  tip="购车价格不能为空,请输入购车价格！"/>
						<span style="color: red;">*</span>
				</td>
			...
			<tr>
				...
				<td class="formTableTdLeft">原来车型：</td>
					<td>
						<input name="customerFile.yetBuyCarModel"  class="largeX text" id="yetBuyCarModel" title="车型"  value="${customerFile.yetBuyCarModel }" ></input>
						<span style="color: red;">*</span>
					</td>
			</tr>
			<%-- <tr>
