...
<link href="${ctx }/css/common.css?d=1" type="text/css" rel="stylesheet"/>
  	...
  	<div class="seracrhOperate">
		...
		<table cellpadding="0" cellspacing="0" class="searchTable" >
  			<tr>
  				...
  				<td>
  					<input class="small text" id="content" name="content"  value="${param.content }" >
				</td>
  				...
  				<td>
  					<select id="taskDealStatus" name="taskDealStatus"  class="text small" onchange="$('#searchPageForm')[0].submit()">
						<option value="">请选择...</option>
						<option value="2" ${param.taskDealStatus==2?'selected="selected"':'' } >已处理</option>
...
<table width="100%" border="0" class="mainTable" cellpadding="0" cellspacing="0">
	...
	<tbody>
		...
		<tr>
			...
			<td style="text-align: center;">
				<a href="javascript:void(-1)" class="aedit" onclick="$.utile.openDialog('/customerTrack/view?dbid=${customerTrack.dbid}&type=1','查看跟进记录',900,500)">查看</a>  
