					...
					<div class="page-content-area">
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter green">经销商类型</h3>
										<p>
											<a href="${ctx }/distributor/add" class="btn btn-app btn-primary" style="font-size: 16px;">
												<i class="ace-icon fa fa-pencil-square-o bigger-230"></i>
												合作经销商
											</a>
											<a href="javascript:void(-1)" onclick="onc('${ctx }/distributor/editEn')" class="btn btn-app btn-success" style="font-size: 16px;">
