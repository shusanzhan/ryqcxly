...
<div class="frmContent">
	...
	<form action="" name="frmId" id="frmId" style="margin-bottom: 40px;" target="_parent">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 96%;">
			...
			<tr height="42">
				...
				<td >
					<input type="text" name="customerPidBookingRecord.bookingDate" id="bookingDate" class="mideaX text" value="${customerPidBookingRecord.bookingDate }" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'orderDate\')}'});" checkType="string,10" tip="请选择预约交车日期">
	...
	<div class="formButton">
		<a href="javascript:void(-1)"	onclick="$.utile.submitAjaxForm('frmId','${ctx}/netTwoCustomer/saveCustomerPid')"	class="but butSave">保存并提报订单</a>
		 <a href="${ctx }/netTwoCustomer/addDecore?customerId=${customer.dbid }&orderContractId=${customer.orderContract.dbid}"	onclick="goBack()" class="but butCancle">上一步</a> 
	</div>
</div>
</body>
