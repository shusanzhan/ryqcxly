...
<input type="hidden" value="${param.orderContractId }" id="orderContractId" name="orderContractId">
</c:if>
<c:if test="${!empty(orderContractDecore) }">
	<input type="hidden" value="${orderContract.dbid }" id="orderContractId" name="orderContractId">
</c:if>
<input type="hidden" value="${orderContractDecore.dbid }" id="orderContractDecoreDbid" name="orderContractDecore.dbid">
<input type="hidden" value="${orderContractExpenses.dbid }" id="orderContractExpenseId" name="orderContractExpenseId">
...
<div class="container-fluid" style="margin-top: 0;">
	<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;margin-top: 12px;" >
		<tr>
			...
			<td  colspan="">
				<input type="text" readonly="readonly" name="orderContractDecore.acturePrice" id="acturePrice" value="${orderContractExpenses.decoreMoney}" class="largeX text">
			</td>
...
<div class="formButton">
		<a id="submit"  class="but butSave" href="javascript:void(-1)" onclick="if(valida()){$.utile.submitAjaxForm('frmId','${ctx}/netTwoCustomer/saveOrderContractDecore')}" >
		保存</a>
		<a class="but butCancle" href="javascript:void(-1)" onclick="window.history.go(-1)">上一步</a>
</div>
