...
<table border="0" align="center" cellpadding="0" cellspacing="0" >
	...
	<tr height="42">
		...
		<td colspan="3">
				<input type="text"  name="orderContractExpenses.cashBenefit" id="cashBenefit" value="0.0" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();" class="largeX text" style="color: red;" ></input>
	...
	<tr height="42">
		<td class="formTableTdLeft">特殊政策优惠：&nbsp;</td>
			<td >
			<input type="text" name="orderContractExpenses.specialPermPrice" id="specialPermPrice" onfocus="orderContranctTotalPrice();" onkeyup="orderContranctTotalPrice();" value="0.0" class="largeX text" style="color: red;"></input>
			<span style="color: red">*</span>
		</td>
	...
	<tr height="42">
		<td class="formTableTdLeft">购车定金：&nbsp;</td>
				<td >
				<input type="text" name="orderContractExpenses.orderMoney" id="orderMoney" onfocus="target32(this.value)" onkeyup="target32(this.value)" value="" class="largeX text" style="color: red;"></input>
				<span style="color: red">*</span>
		...
		<tr height="42" id="dakkuanTr1" style="display: none;">
			...
			<td colspan="3">
				<input type="text"   id="ajsxf" name="orderContractExpenses.ajsxf" class="largeX text" value="0.00" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();"></input>
			</td>
		</tr>
		<tr height="42" id="dakkuanTr" style="display: none;">
			<td class="formTableTdLeft">首付款：&nbsp;</td>
			<td colspan="">
				<input type="text"   id="sfk" name="orderContractExpenses.sfk" class="largeX text" value="0.00" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();"></input>
			</td>
			<td class="formTableTdLeft">贷款金额：&nbsp;</td>
			<td colspan="">
				<input type="text"   id="daikuan" name="orderContractExpenses.daikuan" class="largeX text" value="0.00" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();"></input>
			</td>
		</tr>
		<tr>
		...
		<!-- 添加时展示页面 -->
				<c:forEach var="i" begin="0" step="1" end="3">
					<tr id="tr${i+1 }">
						...
						<td>
							<input type="text" name="chargeItemPrice" id="chargeItemPrice${i+1 }" class="smallX text" style="width: 92%;" onfocus="chargePrice()" onkeyup="chargePrice()" checkType="integer" canEmpty="Y" tip="请输入商品数量，必须为数字">
						</td>
						<td style="text-align: center;">
			...
			<!-- 添加时展示页面 -->
					<c:forEach var="i" begin="0" step="1" end="3">
						<tr id="tr${i+1 }">
							...
							<td>
								<input type="text" name="preferencePrice" id="preferencePrice${i+1 }"  class="smallX text" style="width: 92%;" onfocus="preferenceItemPrice()" onkeyup="preferenceItemPrice()" checkType="integer" canEmpty="Y" tip="请输入商品数量，必须为数字">
							</td>
							<td style="text-align: center;">
