...
<div class="location">
   	...
   	<a href="javascript:void(-1)" class="current">二网提报订单-费用明细</a>
</div>
<div class="line"></div>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" >
	<tr height="42">
		...
		<td colspan="">
			<input type="text" readonly="readonly" value="${customer.customerBussi.carModel.salePrice }" onkeyup="countActMoney()" id="salePrice" name="orderContractExpenses.salePrice" class="midea text" ></input>
		...
		<td class="formTableTdLeft" style="font-size: 12px;">销售顾问结算价：&nbsp;</td>
		<td colspan="">
	...
	<tr height="42">
		...
		<td colspan="3">
				<input type="text"  name="orderContractExpenses.cashBenefit" id="cashBenefit" value="${orderContractExpenses.cashBenefit }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();" class="largeX text" style="color: red;" ></input>
	...
	<tr height="42">
			<td class="formTableTdLeft">特殊权限：&nbsp;</td>
				...
				<c:if test="${orderContractExpenses.specialPermPrice>0 }" var="status">
					<input type="text" name="orderContractExpenses.specialPermPrice" id="specialPermPrice" value="${orderContractExpenses.specialPermPrice }" onfocus="orderContranctTotalPrice();" onkeyup="orderContranctTotalPrice();"  class="largeX text" style="color: red;"></input>
				</c:if>
				<c:if test="${status==false }">
					<input type="text" name="orderContractExpenses.specialPermPrice" id="specialPermPrice" value="0.0" onfocus="orderContranctTotalPrice();" onkeyup="orderContranctTotalPrice();"  class="largeX text" style="color: red;"></input>
				</c:if>
				<span style="color: red">*</span>
			</td>
		...
		<tr height="42">
			<td class="formTableTdLeft">购车定金：&nbsp;</td>
				<td >
				<input type="text" name="orderContractExpenses.orderMoney" id="orderMoney" value="${orderContractExpenses.orderMoney }" onfocus="target32(this.value)" onkeyup="target32(this.value)"  class="largeX text" style="color: red;"></input>
		...
		<c:if test="${orderContractExpenses.buyCarType==1 }">
			<tr height="42" id="dakkuanTr1" style="display: none;">
				...
				<td colspan="3">
					<input type="text"   id="ajsxf" name="orderContractExpenses.ajsxf" class="largeX text" value="${orderContractExpenses.ajsxf }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();"></input>
				</td>
			</tr>
			<tr height="42" id="dakkuanTr" style="display: none;">
				<td class="formTableTdLeft">首付款：&nbsp;</td>
				<td colspan="">
					<input type="text"   id="sfk" name="orderContractExpenses.sfk" class="largeX text" value="${orderContractExpenses.sfk }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();"></input>
				</td>
				<td class="formTableTdLeft">贷款金额：&nbsp;</td>
				<td colspan="">
					<input type="text"   id="daikuan" name="orderContractExpenses.daikuan" class="largeX text" value="${orderContractExpenses.daikuan }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();"></input>
				</td>
			</tr>
		</c:if>
		...
		<!-- 添加时展示页面 -->
				<c:forEach var="orderContractExpensesChargeItem" items="${orderContractExpensesChargeItems }" varStatus="inde">
					<tr id="tr${inde.index+1 }">
							...
							<td>
								<input type="text" name="chargeItemPrice" id="chargeItemPrice${inde.index+1 }" value="${orderContractExpensesChargeItem.price }" class="smallX text" style="width: 92%;" onfocus="chargePrice()" onkeyup="chargePrice()" checkType="float" canEmpty="Y" tip="请输入商品数量，必须为数字">
							</td>
							<td style="text-align: center;">
				...
				<c:if test="${fn:length(orderContractExpensesChargeItems)<4 }">
					<c:forEach var="i" begin="${fn:length(orderContractExpensesChargeItems) }" step="1" end="3">
						<tr id="tr${i+1 }">
							...
							<td>
								<input type="text" name="chargeItemPrice" id="chargeItemPrice${i+1 }" class="smallX text" style="width: 92%;" onfocus="chargePrice()" onkeyup="chargePrice()" checkType="float" canEmpty="Y" tip="请输入商品数量，必须为数字">
							</td>
							<td style="text-align: center;">
		...
		<table id="preferenceItem" border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;margin-top: 5px;" >
			...
			<!-- 添加时展示页面 -->
					...
					<tr id="tr${inde.index+1 }">
							...
							<td>
								<input type="text" name="preferencePrice" id="preferencePrice${inde.index+1 }" value="${orderContractExpensesPreferenceItem.price }" class="smallX text" style="width: 92%;"onfocus="preferenceItemPrice()" onkeyup="preferenceItemPrice()" checkType="float" canEmpty="Y" tip="请输入商品数量，必须为数字">
							</td>
							<td style="text-align: center;">
				...
				<c:if test="${fn:length(orderContractExpensesPreferenceItems)<4 }">
					<c:forEach var="i" begin="${fn:length(orderContractExpensesPreferenceItems) }" step="1" end="3">
						<tr id="tr${i+1 }">
							...
							<td>
								<input type="text" name="preferencePrice" id="preferencePrice${i+1 }" class="smallX text" style="width: 92%;"onfocus="preferenceItemPrice()" onkeyup="preferenceItemPrice()" checkType="float" canEmpty="Y" tip="请输入商品数量，必须为数字">
							</td>
							<td style="text-align: center;">
...
<div class="formButton">
	<a id="submit" class="but butSave" href="javascript:void(-1)" onclick="if(validateFrmBeforeSmb()){$.utile.submitAjaxForm('frmId','${ctx}/netTwoCustomer/saveOrderContract')}">
		保存并填写装饰项目
	</a>
