...
<body class="bodycolor">
	...
	<div class="formButton">
		<a id="saveButton" href="javascript:void(-1)"	onclick="if(validate1()){$.utile.submitAjaxForm('frmId','${ctx}/netTwoCustomer/saveUpdateCustomerIdCard')}"	class="but butSave">保&nbsp;&nbsp;存</a> 
	</div>
