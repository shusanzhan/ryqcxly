...
<table border="0" align="center" cellpadding="0" cellspacing="0" >
	<tr height="42">
		...
		<td colspan="">
			...
			颜色溢价：<input type="text" name="orderContractExpenses.colorPrice" id="colorPrice"   value="${orderContractExpenses.colorPrice }" class="small text"  onfocus="orderContranctTotalPrice();" onkeyup="orderContranctTotalPrice();" checkType="float,0" canEmpty="Y" style="color: red;width: 68px;" tip="请输入颜色溢价"></input>
		</td>
		...
		<td colspan="">
			...
			<c:if test="${status==false }">
				<input type="text" readonly="readonly" value="${orderContractExpenses.carSalerPrice }" onkeyup="countActMoney()" id="carSalerPrice" name="orderContractExpenses.carSalerPrice" class="largeX text"></input>
			</c:if>			
			<span style="color: red">*</span>
		</td>
	</tr> 
	<tr height="42">
		...
		<td colspan="1">
				<input type="text"  name="orderContractExpenses.cashBenefit" id="cashBenefit" value="${orderContractExpenses.cashBenefit }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();" class="midea text" style="color: red;"  checkType="float,0" canEmpty="Y" style="color: red;" tip="请输入裸车现金优惠,必须为数字,可不填写"></input>
				<span style="color: red">*</span>不包含大客户、自有车等特殊权限优惠
		</td>
		<td class="formTableTdLeft">未折让权限：&nbsp;</td>
		<td colspan="1">
				<input type="text" readonly="readonly"  name="orderContractExpenses.noWllowancePrice" id="noWllowancePrice" value="${orderContractExpenses.noWllowancePrice }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();" class="largeX text" style="color: red;"  tip="未折让权限"></input>
				<span style="color: red">*</span>
		</td>
	</tr>
	<tr height="42">
			<td class="formTableTdLeft">特殊权限：&nbsp;</td>
				...
				<c:if test="${orderContractExpenses.specialPermPrice>0 }" var="status">
					<input type="text" name="orderContractExpenses.specialPermPrice" id="specialPermPrice" value="${orderContractExpenses.specialPermPrice }" onfocus="orderContranctTotalPrice();" onkeyup="orderContranctTotalPrice();"  class="largeX text" style="color: red;" checkType="float,0" canEmpty="Y" style="color: red;" tip="请输入特殊政策优惠,必须为数字,可不填写"></input>
				</c:if>
				<c:if test="${status==false }">
					<input type="text" name="orderContractExpenses.specialPermPrice" id="specialPermPrice" value="0.0" onfocus="orderContranctTotalPrice();" onkeyup="orderContranctTotalPrice();"  class="largeX text" style="color: red;" checkType="float,0" canEmpty="Y" style="color: red;" tip="请输入特殊政策优惠,必须为数字,可不填写"></input>
				</c:if>
				<span style="color: red">*</span>
			</td>
		...
		<tr height="42">
			<td class="formTableTdLeft">购车定金：&nbsp;</td>
				<td >
				<input type="text" name="orderContractExpenses.orderMoney" id="orderMoney" value="${orderContractExpenses.orderMoney }" onfocus="target32(this.value)" onkeyup="target32(this.value)"  class="largeX text" style="color: red;" checkType="float,0" style="color: red;" tip="请输入购车定金,大于或等0"></input>
		...
		<c:if test="${orderContractExpenses.buyCarType==1 }">
			<tr height="42" id="dakkuanTr1" style="display: none;">
				...
				<td colspan="3">
					<input type="text"   id="ajsxf" name="orderContractExpenses.ajsxf" class="largeX text" value="${orderContractExpenses.ajsxf }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();" checkType="float,0" canEmpty="Y" style="color: red;" tip="请输入咨询服务费"></input>
				</td>
			</tr>
			<tr height="42" id="dakkuanTr" style="display: none;">
				<td class="formTableTdLeft">首付款：&nbsp;</td>
				<td colspan="">
					<input type="text"   id="sfk" name="orderContractExpenses.sfk" class="largeX text" value="${orderContractExpenses.sfk }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();" checkType="float,0" canEmpty="Y" style="color: red;" tip="请输入首付款"></input>
				</td>
				<td class="formTableTdLeft">贷款金额：&nbsp;</td>
				<td colspan="">
					<input type="text"   id="daikuan" name="orderContractExpenses.daikuan" class="largeX text" value="${orderContractExpenses.daikuan }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();" checkType="float,0" canEmpty="Y" style="color: red;" tip="请输入贷款金额"></input>
				</td>
			</tr>
		</c:if>
		<c:if test="${orderContractExpenses.buyCarType==2 }">
			...
			<tr height="42" id="dakkuanTr" >
				...
				<td class="formTableTdLeft">贷款金额：&nbsp;</td>
				<td colspan="">
					<input type="text"   id="daikuan" name="orderContractExpenses.daikuan" class="largeX text" value="${orderContractExpenses.daikuan }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();" checkType="float,0" canEmpty="Y" style="color: red;" tip="请输入贷款金额"></input>
				</td>
			</tr>
		</c:if>
		<tr>
		...
		<tr>
				...
				<td colspan="3">
						<input type="text" readonly="readonly" name="orderContractExpenses.totalPrice" id="totalPrice" value="${orderContractExpenses.totalPrice }" onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();" class="largeX text" style="color: red;"></input>
						<span style="color: red">*</span>
...
<div id='chargeItemDiv' style="width: 100%">
		...
		<!-- 添加时展示页面 -->
				<c:forEach var="orderContractExpensesChargeItem" items="${orderContractExpensesChargeItems }" varStatus="inde">
					<tr id="tr${inde.index+1 }">
							...
							<td>
								<input type="text" name="chargeItemPrice" id="chargeItemPrice${inde.index+1 }" value="${orderContractExpensesChargeItem.price }" class="smallX text" style="width: 92%;" onfocus="chargePrice()" onkeyup="chargePrice()" checkType="float" canEmpty="Y" tip="请输入其他收费金额，必须为数字">
							</td>
							<td style="text-align: center;">
				...
				<c:if test="${fn:length(orderContractExpensesChargeItems)<4 }">
					<c:forEach var="i" begin="${fn:length(orderContractExpensesChargeItems) }" step="1" end="3">
						<tr id="tr${i+1 }">
							...
							<td>
								<input type="text" name="chargeItemPrice" id="chargeItemPrice${i+1 }" class="smallX text" style="width: 92%;" onfocus="chargePrice()" onkeyup="chargePrice()" checkType="float" canEmpty="Y" tip="请输入其他收费金额，必须为数字">
							</td>
							<td style="text-align: center;">
	...
	<table  border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;border-top: 0px;" >
		<tr height="42" style="background-color: #eeeeee; border-color:#eeeeee;font-size: 16px;font-weight: bold;border-top: 0px;">
			<td width="100%" colspan="5" style="text-align: right;padding-right: 12px;border-top: 0px;">其他收费总额:<span style="font-size: 20px;color: red;margin:0 5px;" id="otherFeePriceText">${ orderContractExpenses.otherFeePrice}</span>元</td>
		</tr>
	</table>
</div>
		...
		<table id="preferenceItem" border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;margin-top: 5px;" >
			...
			<!-- 添加时展示页面 -->
					...
					<tr id="tr${inde.index+1 }">
							...
							<td>
								<input type="text" name="preferencePrice" id="preferencePrice${inde.index+1 }" value="${orderContractExpensesPreferenceItem.price }" class="smallX text" style="width: 92%;"onfocus="preferenceItemPrice()" onkeyup="preferenceItemPrice()" checkType="float" canEmpty="Y" tip="请输入预收项目金额，必须为数字">
							</td>
							<td style="text-align: center;">
				...
				<c:if test="${fn:length(orderContractExpensesPreferenceItems)<4 }">
					<c:forEach var="i" begin="${fn:length(orderContractExpensesPreferenceItems) }" step="1" end="3">
						<tr id="tr${i+1 }">
							...
							<td>
								<input type="text" name="preferencePrice" id="preferencePrice${i+1 }" class="smallX text" style="width: 92%;"onfocus="preferenceItemPrice()" onkeyup="preferenceItemPrice()" checkType="float" canEmpty="Y" tip="请输入预收项目金额，必须为数字">
							</td>
							<td style="text-align: center;">
