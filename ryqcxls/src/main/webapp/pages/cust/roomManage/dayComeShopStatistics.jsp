...
<div class="row-fluid" >
	  	<div class="seracrhOperate" style="float: left;">
	  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/roomManage/dayComeShopStatistics" method="post" >
			...
			<table cellpadding="0" cellspacing="0" class="searchTable" >
	  			<tr>
	  				<td>日期：</td>
	  				<td>
	  					<input class="midea text" id="startTime" name="startTime" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM'})" value="${start }" >
	  				</td>
