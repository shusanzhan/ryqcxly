			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content">
						...
						<a href="${ctx }/cityCross/queryCityCrossCount" class="label label-info" style="padding: 8px 12px;margin-right: 12px;">
							同城交叉客户
						</a>
						<a href="${ ctx}/cust/queryList" class="label label-info" style="padding: 8px 12px;margin-right: 12px;">
							基盘客户统计
						</a>
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content">
						<a href="javascript:void(-1)" class="label label-info" style="padding: 8px 12px;margin-right: 12px;" onclick="window.location.href='${ctx}/statistics/noCarStatistics'">无车订单</a>
						...
						<a href="javascript:void(-1)" class="label label-info" style="padding: 8px 12px;margin-right: 12px;" onclick="window.location.href='${ctx}/order/queryOrderList'">订单报表</a>
					</div>
				</div>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content">
						<a href="javascript:void(-1)" class="label label-info" style="padding: 8px 12px;margin-right: 12px;" onclick="window.location.href='${ctx}/wlbOrderFactRef/queryWlbOrderFactRef'">存销比报表</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content">
						...
						<a href="javascript:void(-1)" class="label label-info" style="padding: 8px 12px;margin-right: 12px;" onclick="window.location.href='${ctx}/customerTrackStatic/today?role=gm'">每日回访数据监控</a>
