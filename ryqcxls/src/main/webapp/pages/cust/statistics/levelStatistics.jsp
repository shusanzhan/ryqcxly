...
$(function () {
    ...
    var levelLV=eval("${levelLV}");
    var levelFV=eval("${levelFV}");
...
<div class="row-fluid" >
	  	<div class="seracrhOperate" style="float: left;">
	  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/statistics/levelStatistics" method="post" >
		...
		<tbody>
			<tr>
			 ...
			 <tr>
				<td>L</td>
				<c:set value="0" var="total"></c:set>	
				<c:forEach items="${levelLs }" var="levelL">
					<td>${levelL.countNum}</td>
					<c:set value="${ total+levelL.countNum}"  var="total"></c:set>
				</c:forEach>
				<td>${total }</td>
			</tr>
			 <tr>
				<td>F</td>
				<c:set value="0" var="total"></c:set>	
				<c:forEach items="${levelFs }" var="levelF">
					<td>${levelF.countNum}</td>
					<c:set value="${ total+levelF.countNum}"  var="total"></c:set>
				</c:forEach>
				<td>${total }</td>
			</tr>
		</tbody>
