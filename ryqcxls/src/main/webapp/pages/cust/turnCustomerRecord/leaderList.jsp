...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="window.location.href='${ctx}/turnCustomerRecord/queryLeaderList'">转单操作管理</a>
</div>
 <!--location end-->
<div class="line"></div>
...
<div class="listOperate">
	<div class="operate">
		<a class="but button" href="javascript:void();" onclick="window.location.href='${ctx}/turnCustomerRecord/add'">添加</a>
  	...
  	<div class="seracrhOperate">
  		 <form name="searchPageForm" id="searchPageForm" action="${ctx}/turnCustomerRecord/queryLeaderList" method="post">
		...
		<input type="hidden" id="type" name="type" value='0'>
  		<table cellpadding="0" cellspacing="0" class="searchTable" >
  			<tr>
  				...
  				<td><input type="text" id="operatorName" name="operatorName" class="text midea" value="${param.operatorName}"></input></td>
...
<thead class="TableHeader">
	<tr>
		...
		<td class="span1">原销售顾问</td>
		<td class="span1">目标销顾问</td>
...
<c:forEach var="turnCustomerRecord" items="${page.result }">
	<tr height="32" align="center">
		...
		<td>
			<a href="javascript:void(-1)" class="aedit"	onclick="$.utile.operatorDataByDbid('${ctx }/turnCustomerRecord/canncelTurn?dbid=${turnCustomerRecord.dbid}','searchPageForm','您确定撤销转单吗')">撤销</a>|
