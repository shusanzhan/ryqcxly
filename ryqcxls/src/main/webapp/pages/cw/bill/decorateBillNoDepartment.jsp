...
<div class="location">
		...
		<a href="javascript:void(-1);" onclick="javascript:void(-1);">装饰成本应付挂账(无装饰部)</a>
</div>
<div class="line"></div>
<div class="frmContent">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 98%;">
			<tr height="42">
				<td class="formTableTdLeft" style="width:20%" >出库单号:&nbsp;</td>
				<td colspan="4">
			...
			<tr height="42">
				...
				<td style="width:30%">
					<input type="text" name="custName" id="custName"   readonly="readonly"  class="large text" title="客户姓名" checkType="string,1,30" tip="客户姓名不能为空"/><span style="color:red;">*</span>
				</td>
				<td class="formTableTdLeft" style="width:20%">电话号码:&nbsp;</td>
				<td style="width:30%">
					<input type="text" name="custTel" id="custTel" value="" title="客户电话号码" tip="客户电话号码" class="large text" readonly="readonly">
				</td>	
			</tr>
			<tr height="42">
					...
					<select id="saleCompany"  name="financeId" class="large text" checkType="string,1,2" tip="挂帐单位名称不能为空">
						<option value="">请先选择...</option>
							<c:forEach var="supplier" items="${suppliers}">
								<option value="${supplier.dbid}">${supplier.name }</option>
							</c:forEach>
					</select> --%>
			<td>
					<input type="text" name="bill.billCompany" id="billCompany" class="largeX text"  checkType="string,1,50" tip="单位名称"> </input>
			</td>
	...
	<div class="formButton">
	  	<a href="javascript:void(-1)"	onclick="$.utile.submitForm('frmId','${ctx}/bill/decoreCostBillNo')"	class="but butSave">保&nbsp;&nbsp;存</a> 
...
//搜索挂账单位名称
function autoOutNo(id){
 	var id1 = "#" + id;
	$(id1).autocomplete("${ctx}/bill/ajaxdecoreCostNo",{
		max:20,
		width:130,
		matchSubset:false,
		matchContains:true,
		...
		formatItem:function(row,i,total){
			return "<span>出库单号："+row.outNo+"&nbsp;&nbsp;&nbsp;客户姓名："+row.custName+"&nbsp;&nbsp;&nbsp;客户电话："+row.custTel+"</span>";
		},
