...
<div class="location">
		...
		<a href="javascript:void(-1);" onclick="javascript:void(-1);">保险返利应收挂账</a>
</div>
<div class="line"></div>
<div class="frmContent">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 98%;">
			<tr height="42">
				<td class="formTableTdLeft" style="width:20%" >保险客户姓名:&nbsp;</td>
				<td style="width:30%">
					<input type="text" name="bill.custName" id="custName" onfocus="autoInfo('custName')" placeholder="请输入保险客户名字" class="large text" title="名字" checkType="string,1,10" tip="保险客户名字不能为空"/><span style="color:red;">*</span>
				</td>
			...
			<tr height="42">
				...
				<td style="width:30%">
					<input type="text" name="billProject" id="billProject" value="保险返利" title="挂帐项目" tip="挂帐项目" class="large text" readonly="readonly">
				</td>
			</tr>	
			<tr height="42">
				<td class="formTableLeft" style="width:20%">该笔返利金额:&nbsp;</td>
				<td style="width:30%">
	...
	<div class="formButton">
	  	<a href="javascript:void(-1)"	onclick="$.utile.submitForm('frmId','${ctx}/bill/insuranceSave')"	class="but butSave">保&nbsp;&nbsp;存</a> 
...
function autoInfo(id){
	var id1 = "#" + id;
	$(id1).autocomplete("${ctx}/bill/ajaxInsurance",{
		max:20,
		width:130,
		matchSubset:false,
		matchContains:true,
		...
		formatItem:function(row,i,total){
			return "<span>用户Id："+row.custDbid+"&nbsp;&nbsp;&nbsp;用户名："+row.custName+"&nbsp;&nbsp;&nbsp;挂账单位名称："+row.unitName+"</span>";
		},
...
function onRecordSelect(event,data,formatted){
	...
	$("#insuranceDbid").val(data.dbid);
	$("#dbid").val(data.dbid);
	$("#totalPayOrReceive").val(data.rebateMoney);
