...
<body class="bodycolor">
	...
	<div class="formButton">
		<a id="saveButton" href="javascript:void(-1)"	onclick="$('#status').val(3);$.utile.submitAjaxForm('frmId','${ctx}/cwAppmodifydata/saveDecoreApproval')"	class="but butSave">同意</a> 
		<a id="saveButton" href="javascript:void(-1)"	onclick="$('#status').val(2);$.utile.submitAjaxForm('frmId','${ctx}/cwAppmodifydata/saveDecoreApproval')"	class="but butSave">驳回</a> 
