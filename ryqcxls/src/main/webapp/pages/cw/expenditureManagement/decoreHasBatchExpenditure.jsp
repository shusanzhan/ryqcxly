...
<title>装饰批量支出(有装饰部)</title>
</head>
<body class="bodycolor">
<div class="location">
   	<img src="${ctx}/images/homeIcon.png"/> &nbsp;
   	<a href="javascript:void(-1);" onclick="window.parent.location.href='${ctx}/main/index'">首页</a>-
	<a href="javascript:void(-1);" onclick="window.location.href='${ctx}/expenditureManagement/decoreNoExpenditureList'">装饰批量支出管理(有装饰部)</a>-
...
<div class="frmContent">
	...
	<c:forEach var="purchaseStorage" items="${purchaseStorages }" >
		<span class="cust" style="">${purchaseStorage.sn }【￥${purchaseStorage.purchaseMoney }】</span>
		<c:set value="${purchaseStorage.purchaseMoney+totalMoney }" var="totalMoney"></c:set>
		<input type="hidden" name="id" value="${purchaseStorage.dbid}">
	</c:forEach>
	...
	<div class="formButton">
	    <a id="correct" href="javascript:void(-1)"	 onclick="$.utile.submitFrm('frmId1','${ctx}/expenditureManagement/batchCashDecoreHas')"	class="but butSave dis">确定支出（￥${totalMoney }）</a> 
