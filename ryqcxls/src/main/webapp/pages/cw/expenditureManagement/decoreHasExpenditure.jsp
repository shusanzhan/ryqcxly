...
<table border="0" align="center" cellpadding="0" cellspacing="0"  style="width:100%">
	...
	<div class="formButton">
		<a href="javascript:void(-1)"	 id="correct" style="display:none" onclick="$.utile.submitFrm('frmId','${ctx}/expenditureManagement/saveCarCostExpenditure')"	class="but butSave">保&nbsp;&nbsp;存</a> 
