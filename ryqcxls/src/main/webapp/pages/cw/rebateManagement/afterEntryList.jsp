...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="">工厂售后返利录入列表</a>
</div>
 <!--location end-->
<div class="line"></div>
<div class="listOperate">
	<div class="operate">
  	...
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/rebateManagement/queryAfterEntryList" method="post" >
...
<table width="100%" border="0" class="mainTable" cellpadding="0" cellspacing="0">
	<thead>
		<tr>
			<td class="sn">
			<input type='checkbox' id="selectAllCheck" onclick="selectAll(this,'id')" onchange="sum()"/>
			</td>
...
function batchEntry	(){
	...
	window.top.art.dialog({
		...
		lock : true,
		ok : function() {
			window.location.href="${ctx }/rebateManagement/optionRebateType?dbids="+dbids+"&type=2";
		},
		cancel : true
	});
}
