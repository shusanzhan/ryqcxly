...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="window.location.href='${ctx}/rebateManagement/queryUnCashList'">工厂返利收银</a>-
...
<div class="frmContent">
	...
	<div>
		<c:forEach var="factoryOrder" items="${factoryOrders }" >
			<span class="cust" style="">${factoryOrder.vinCode }【<ystech:factoryRebateUnCashMoney factoryOrderId="${factoryOrder.dbid }" />】
			</span>
	...
	<div class="formButton">
		<a id="correct" href="javascript:void(-1)"	 onclick="$.utile.submitFrm('frmId1','${ctx}/rebateManagement/saveBatchCash')"	class="but butSave dis">确定收银（￥${totalMoney }）</a> 
