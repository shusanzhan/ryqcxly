	...
	<form action="" name="frmId" id="frmId"  target="_self">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 98%;">
			<tr height="42">
				...
				<td colspan="3"><input type="text" name="finCustomer.custNo" id="custNo"	value="${finCustomer.custNo }" class="large text" title="客户编号" checkType="string,1,50" tip="客户编号不能为空"><span style="color: red;">*</span></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">申请人:&nbsp;</td>
				<td ><input type="text" name="finCustomer.name" id="name"	value="${finCustomer.name }" class="large text" title="名称" onfocus="autoCustomer('name')"	checkType="string,1,50" tip="名称不能为空"><span style="color: red;">*</span></td>
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 98%;">
			...
			<tr height="42">
				...
				<td colspan="">
					<input type="text" name="finCustomerLoan.discountMony" id="discountMony"	value="${finCustomerLoan.discountMony }" class="large text" title="贴息金额" checkType="float,0"  onkeyup="profit()" tip="贴息金额"><span style="color: red;">*</span>
				</td>
			</tr>
			<tr height="42">
			...
			<tr height="42">
				...
				<td>
					<input type="text" name="finCustomerLoan.profitPrice" id="profitPrice"	value="${finCustomerLoan.profitPrice }" class="large text" title="名称" onfocus="autoCustomer('name')"	checkType="string,1,50" tip="名称不能为空"><span style="color: red;">*</span>
					<br>
			...
			<tr height="62" style="height: 60px;">
				...
				<td colspan="3">
					<select id="editReson" name="editReson" class="large text" checkType="integer,1" tip="请选择修改资料原因">
...
function onRecordSelect(event, data, formatted) {
		...
		$("#salerDiscountPrice").val(data.salerDiscountPrice);
