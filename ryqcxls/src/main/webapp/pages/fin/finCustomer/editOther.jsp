...
<div class="frmContent">
	<form action="" name="frmId" id="frmId"  target="_self">
		...
		<c:if test="${empty(finCustomer) }">
			<input type="hidden" name="finCustomer.customerType" id="customerType" value="2">
		</c:if>
		<c:if test="${!empty(finCustomer) }">
		...
		<input type="hidden" name="finCustomerLoan.loanProfitPrice" id="loanProfitPrice" value="${finCustomerLoan.loanProfitPrice }">
		<input type="hidden" name="finCustomerLoan.otherProfitPrice" id="otherProfitPrice" value="${finCustomerLoan.otherProfitPrice }">
		<div class="frmTitle" onclick="showOrHiden('contactTable')">贷款人信息</div>
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				<td class="formTableTdLeft">客户编号:&nbsp;</td>
				<td colspan="3"><input type="text" name="finCustomer.custNo" id="custNo"	value="${finCustomer.custNo }" class="largeX text" title="客户编号" checkType="string,1,50" tip="客户编号不能为空"><span style="color: red;">*</span></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">申请人:&nbsp;</td>
				<td ><input type="text" name="finCustomer.name" id="name"	value="${finCustomer.name }" class="largeX text" title="名称" 	checkType="string,1,50" tip="名称不能为空"><span style="color: red;">*</span></td>
				<td class="formTableTdLeft">申请人电话:&nbsp;</td>
				<td ><input type="text" name="finCustomer.mobilePhone" id="mobilePhone"
					value="${finCustomer.mobilePhone }" class="largeX text" title="申请人电话"	checkType="mobilePhone" tip="申请人电话不能为空" ><span style="color: red;">*</span></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">身份证号:&nbsp;</td>
				<td ><input type="text"  name="finCustomer.icard" id="icard"	value="${finCustomer.icard }" class="largeX text" title="名称"	checkType="IDCard" tip="身份证号不能为空"></td>
				<td class="formTableTdLeft">地址:&nbsp;</td>
				<td >
					<input type="hidden" id="areaId" name="areaId" value="${finCustomer.area.dbid }">
					<input type="text" name="finCustomer.address" id="address"	value="${finCustomer.address }" class="largeX text" title="名称"	checkType="string,1"  tip="地址不能为空">
				</td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">共申人:&nbsp;</td>
				<td ><input type="text" name="finCustomer.commName" id="commName"
					value="${finCustomer.commName }" class="largeX text" title="共申人"	checkType="string,1"  tip="共申人不能为空"></td>
				<td class="formTableTdLeft">共申人电话:&nbsp;</td>
				<td ><input type="text" name="finCustomer.commMobilePhone" id="commMobilePhone"
					value="${finCustomer.commMobilePhone }" class="largeX text" title="共申人电话"	checkType="mobilePhone" tip="共申人电话不能为空"></td>
			</tr>
			<tr height="42">
				...
				<td >
					...
					<input type="text" name="finCustomer.carSeriyName" id="carSeriyName" value="${finCustomer.carSeriyName }" class="largeX text" title="车型"	checkType="string,1" tip="车型不能为空">
				</td>
				<td class="formTableTdLeft">销售员:&nbsp;</td>
				<td ><input type="text" name="finCustomer.saler" id="saler"	value="${finCustomer.saler }" onfocus="autoUser('saler')" class="largeX text" title="销售员"	checkType="string,1"  tip="销售员不能为空"></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">销售员电话:&nbsp;</td>
				<td ><input type="text" name="finCustomer.salerPhone" id="salerPhone" value="${finCustomer.salerPhone }" class="largeX text" title="销售员电话"	checkType="string,1"  tip="销售员电话不能为空"></td>
				<td class="formTableTdLeft">部门:&nbsp;</td>
				<td >
					<select class="midea text" id="depId" name="depId"  checkType="integer,1" tip="请选择部门">
			...
			<tr height="42">
				...
				<td >
					<select id="storeAreaId" name="storeAreaId" class="largeX text" checkType="integer,1">
				...
				<td >
					<select id="saleCompanyId" name="saleCompanyId" class="largeX text" checkType="integer,1">
						<option value="-1">请选择...</option>
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				...
				<td ><input type="text" name="finCustomerLoan.carPrice" id="carPrice" onchange="jisuan()" onfocus="jisuan()"	value="${finCustomerLoan.carPrice }" class="largeX text" title="名称" 	checkType="string,1,50" tip="名称不能为空"><span style="color: red;">*</span></td>
				<td class="formTableTdLeft">开票价:&nbsp;</td>
				<td ><input type="text" name="finCustomerLoan.kaiPiaoPrice" id="kaiPiaoPrice"
					value="${finCustomerLoan.kaiPiaoPrice }" class="largeX text" title="月数"	checkType="float,0" tip="月数不能为空,且只能为数字"><span style="color: red;">*</span></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">贷款金额:&nbsp;</td>
				<td ><input type="text" name="finCustomerLoan.loanPrice" id="loanPrice"	value="${finCustomerLoan.loanPrice }" class="largeX text" title="贷款金额" onfocus="jisuan()" onchange="jisuan()"	checkType="float,0" tip="贷款金额不能为空"><span style="color: red;">*</span></td>
				<td class="formTableTdLeft">手续费:&nbsp;</td>
				<td ><input type="text" name="finCustomerLoan.countFee" id="countFee"
					value="${finCustomerLoan.countFee }" class="largeX text" title="手续费" onchange="profit()"	checkType="float,0" tip="手续费不能为空,且只能为数字"><span style="color: red;">*</span></td>
			</tr>
			<tr height="42">
			...
			<tr height="42">
				...
				<td id="monthSupPriceTr">
					<input readonly="readonly" type="text" name="finCustomerLoan.monthSupPrice" id="monthSupPrice"	value="${finCustomerLoan.monthSupPrice }" class="largeX text" title="名称" >
				</td>
				<td class="formTableTdLeft" id="yearSupPriceLable" style="display: none;">按年还:&nbsp;</td>
				<td id="yearSupPriceTr" style="display: none;">
					<input readonly="readonly" type="text" name="finCustomerLoan.yearSupPrice" id="yearSupPrice"	value="${finCustomerLoan.yearSupPrice }" class="largeX text" title="名称" >
				</td>
				<td class="formTableTdLeft">利息:&nbsp;</td>
				<td>
					<input readonly="readonly" type="text" name="finCustomerLoan.annualInterest" id="annualInterest" value="${finCustomerLoan.annualInterest }" class="largeX text" title="月数">
				</td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">工厂税后毛利:&nbsp;</td>
				<td>
					<input type="text" name="finCustomerLoan.factoryProfitPrice" id="factoryProfitPrice"	value="${finCustomerLoan.factoryProfitPrice }" onkeyup="profit()" class="large text" title="工厂税后毛利" 	checkType="float,0" tip="工厂税后毛利不能为空"><span style="color: red;">*</span>
				</td>
			...
			<tr height="42">
				...
				<td>
					<input type="text" name="finCustomerLoan.actDiscountPrice" id="actDiscountPrice"	value="${finCustomerLoan.actDiscountPrice }" class="midea text" title="名称" 	checkType="string,1,50" tip="名称不能为空"><span style="color: red;">*</span>
					贷款额/10000*贴息系数
				</td>
				<td class="formTableTdLeft">公司贴息:&nbsp;</td>
				<td >
					<input type="text" name="finCustomerLoan.companyDiscountPrice" id="companyDiscountPrice"
					value="${finCustomerLoan.companyDiscountPrice }" class="midea text" title="公司贴息"	checkType="float" tip="公司贴息不能为空"><span style="color: red;">*</span>
					实际利息-贴息金额
				</td>
			</tr>
			<tr height="42">
			...
			<tr height="42">
				...
				<td ><input type="text" name="finCustomerLoan.otherPrice" id="otherPrice"	value="${finCustomerLoan.otherPrice }" class="largeX text" title="其他收费" onkeyup="profit()"	checkType="float" canEmpty="Y" tip="其他收费,可以为空"></td>
				<td class="formTableTdLeft">其他收费备注:&nbsp;</td>
				<td ><input type="text" name="finCustomerLoan.otherPriceNote" id="otherPriceNote" value="${finCustomerLoan.otherPriceNote }" class="largeX text" title="其他收费备注"	></td>
			</tr>
			<tr height="42">
			...
			<tr height="42">
				...
				<td>
					...
					<br>
					<span style="font-size: 8px;">手续费+盗抢险+其他收-公司贴息+工厂返利+续保佣金</span>
				</td>
			...
			<tr height="42">
				...
				<td colspan="3" c>
					<input type="text" readonly="readonly" name="finCustomerLoan.loanPer" id="loanPer"	value="${finCustomerLoan.loanPer }" class="large text" title="贷款成数" 	checkType="float" tip="贷款成数不能为空">
				</td>
			</tr>
			<tr height="32">
			...
			<c:if test="${finCustomer.applyStatus==2 }">
				<tr height="62" style="height: 60px;">
					<td class="formTableTdLeft">修改资料原因:&nbsp;</td>
					<td colspan="3">
						<select id="editReson" name="editReson" class="largeX text" checkType="integer,1" tip="请选择修改资料原因">
							<option value="0">请先选...</option>
							<option value="1">换贷款申请人</option>
							<option value="2">换车型</option>
							<option value="3">换贷款产品</option>
							<option value="4">换车换贷款产品</option>
							<option value="5">其他</option>
						</select>
						<span style="color: red;">*说明：操作选择【其他】将不对客户状态重置，选择【其他】以外的原因系统将把客户设置为登记状态。</span>
					</td>
				</tr>
			</c:if>
		</table>
	...
	<div class="formButton">
		<a href="javascript:void(-1)"	onclick="$.utile.submitForm('frmId','${ctx}/finCustomer/save')"	class="but butSave">保&nbsp;&nbsp;存</a> 
