...
<div class="listOperate">
	<div class="operate">
		<a class="but butCancle" href="javascript:void();" onclick="$.utile.deleteIds('${ctx }/finCustomer/delete','searchPageForm')">删除</a>
   </div>
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm" action="${ctx}/finCustomer/queryFlowList" method="post">
...
<table width="100%"  cellpadding="0" cellspacing="0" class="mainTable" border="0">
	...
	<c:forEach var="finCustomer" items="${page.result }">
		<tr height="32" align="center">
			...
			<td>
				<a href="javascript:void(-1)" class="aedit" onclick="$.utile.operatorDataByDbid('${ctx }/finCustomer/saveTurnFlowerToCustomer?finCustomerId=${finCustomer.dbid }','searchPageForm','您确定将【${finCustomer.name }】转为登记客户吗？')">转为登记客户</a>
				|
				<a href="#" class="aedit" onclick="$.utile.deleteById('${ctx }/finCustomer/delete?dbids=${finCustomer.dbid}')">删除</a>
			</td>
