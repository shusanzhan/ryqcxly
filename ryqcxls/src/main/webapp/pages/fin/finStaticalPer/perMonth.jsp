...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           <li class="detail_tap3 detail_tap pull_left select" id="imgs_tap" onclick="window.location.href='${ctx}/finStaticalPer/perMonth'">月报</li>
           <li class="detail_tap3 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/finStaticalPer/perQuarter'">季报</li>
            <li class="detail_tap3 detail_tap pull_left" id="pingjia_tap" onclick="window.location.href='${ctx}/finStaticalPer/perYear'">年报</li>
      	</ul>
     </div>
 </div>
<form action="${ctx }/finStaticalPer/perMonth" name="frmId" id="frmId" method="post">
<table border="0" align="left" cellpadding="0" cellspacing="0" style="width: 300px;margin-top: 12px;border: 0px;">
	<tr height="42">
		<td class="formTableTdLeft" width="80">统计日期:&nbsp;
			<input readonly="readonly" type="text" name="month" id="month" value="${param.month }"  onfocus="WdatePicker({dateFmt:'yyyy-MM'})" class="small text" >
...
<div class="frmTitle" onclick="showOrHiden('contactTable')">${title }月车系渗透率统计</div>
...
<div class="frmTitle" onclick="showOrHiden('contactTable')">${title }月部门渗透率统计</div>
<table id="shopNumber" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 5px;width: 98%;margin-right: 5px;margin-left: 5px;">
	<tr height="32" style="background-color: #eeeeee; border-color:#eeeeee;font-size: 14px;font-weight: bold;">
			<th style="width: 30px;text-align: center;">序号</th>
			<th style="width: 60px;text-align: center;">部门</th>
			<th style="width: 60px;text-align: center;"  >实销</th>
			<th style="width: 70px;text-align: center;"  >按揭</th>
			<th style="width: 70px;text-align: center;"  >渗透率</th>
			<th style="width: 80px;text-align: center;"  >产值</th>
			<th style="width: 120px;text-align: center;"  >平均产值</th>
...
<div class="frmTitle" onclick="showOrHiden('contactTable')">${title }月销售人员渗透率统计</div>
<table id="shopNumber" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 5px;width: 98%;margin-right: 5px;margin-left: 5px;">
	<tr height="32" style="background-color: #eeeeee; border-color:#eeeeee;font-size: 14px;font-weight: bold;">
			<th style="width: 30px;text-align: center;">序号</th>
