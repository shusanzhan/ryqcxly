...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           ...
           <li class="detail_tap3 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/finStaticalPer/perQuarter'">季报</li>
            <li class="detail_tap3 detail_tap pull_left" id="pingjia_tap" onclick="window.location.href='${ctx}/finStaticalPer/perYear'">年报</li>
      	</ul>
     </div>
 </div>
<form action="${ctx}/finStaticalPer/perQuarter" name="frmId" id="frmId" method="post">
<table border="0" align="left" cellpadding="0" cellspacing="0" style="width: 500px;margin-top: 12px;border: 0px;">
	<tr height="42">
		<td class="formTableTdLeft" width="80">年:&nbsp;
			<input readonly="readonly" type="text" name="year" id="year" value="${param.year }"  onfocus="WdatePicker({dateFmt:'yyyy'})" class="small text" >
		</td>
		<td class="formTableTdLeft" width="60">季度:&nbsp;
...
<div class="frmTitle" onclick="showOrHiden('contactTable')">${title }车系渗透率统计</div>
...
<div class="frmTitle" onclick="showOrHiden('contactTable')">${title }部门渗透率统计</div>
<table id="shopNumber" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 5px;width: 98%;margin-right: 5px;margin-left: 5px;">
	<tr height="32" style="background-color: #eeeeee; border-color:#eeeeee;font-size: 14px;font-weight: bold;">
			<th style="width: 30px;text-align: center;">序号</th>
...
<div class="frmTitle" onclick="showOrHiden('contactTable')">${title }销售人员渗透率统计</div>
<table id="shopNumber" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 5px;width: 98%;margin-right: 5px;margin-left: 5px;">
	<tr height="32" style="background-color: #eeeeee; border-color:#eeeeee;font-size: 14px;font-weight: bold;">
			<th style="width: 30px;text-align: center;">序号</th>
			<th style="width: 60px;text-align: center;">部门</th>
