...
<div id="hearder_nav" class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">流失客户月报表</span>
...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           ...
           <li class="detail_tap5 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/finCustomerFlowStatical/customer7Day'">最近7日</li>
           ...
           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/finCustomerFlowStatical/customerMonth'">月</li>
...
<div class="row-fluid" style="text-align: center;border-bottom: 1px solid #ed145b;margin-bottom: 12px;color:#ed145b;">
	<h5 style="text-align: left;font-size: 16px">
		流失客户量<span style="font-size: 14px;">(总数：${totalNum }人,今日：${newsCount }人)</span>
	</h5>
</div>
<div class="row-fluid">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/finCustomerFlowStatical/customerMonth" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr>
