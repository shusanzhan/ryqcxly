...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           ...
           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/finCustomerProfitStatical/customerMonth'">月</li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/finCustomerProfitStatical/customerMonth" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr>
