...
<div id="hearder_nav" class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">集客最近7日报表</span>
    <a class="go_home" href="${ctx }/finCustomerRecodStatical/index">
...
<div id="detail_nav">
     <div class="detail_nav_inner">
          <ul class="clearfix padding10">
           <li class="detail_tap5 detail_tap pull_left " id="imgs_tap" onclick="window.location.href='${ctx}/finCustomerRecodStatical/todayStatic'">日</li>
           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/finCustomerRecodStatical/customer7Day'">最近7日</li>
           <li class="detail_tap5 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/finCustomerRecodStatical/customerWeek'">周</li>
           <li class="detail_tap5 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/finCustomerRecodStatical/customerMonth'">月</li>
           <li class="detail_tap5 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/finCustomerRecodStatical/customerYear'">年</li>
      	</ul>
     </div>
 </div>
<div class="row-fluid" style="text-align: center;border-bottom: 1px solid #ed145b;margin-bottom: 12px;color:#ed145b;">
	<h5 style="text-align: left;font-size: 16px">
		最近7日集客量<span style="font-size: 14px;">(总数：${totalNum }人,今日：${newsCount }人)</span>
	</h5>
</div>
<div class="row-fluid">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/finCustomerRecodStatical/todayStatic" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr>
