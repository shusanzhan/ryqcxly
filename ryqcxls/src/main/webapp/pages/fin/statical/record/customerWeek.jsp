...
<div id="hearder_nav" class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">集客最近7周报表</span>
...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           ...
           <li class="detail_tap5 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/finCustomerRecodStatical/customer7Day'">最近7日</li>
           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/finCustomerRecodStatical/customerWeek'">周</li>
