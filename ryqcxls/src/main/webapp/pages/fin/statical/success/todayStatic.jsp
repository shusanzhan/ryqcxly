...
<div id="hearder_nav" class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">成交客户客户</span>
...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           <li class="detail_tap5 detail_tap pull_left select" id="imgs_tap" onclick="window.location.href='${ctx}/finCustomerSuccessStatical/todayStatic'">日</li>
