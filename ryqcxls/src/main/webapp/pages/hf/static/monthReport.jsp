...
<div id="detail_nav">
	<div class="detail_nav_inner">
	      <ul class="clearfix padding10">
	        <li onclick="window.location.href='${ctx }/staticHf/monthReport?brandId=${brandId}&startDate=${startDate }&endDate=${endDate }'" id="imgs_tap" class="detail_tap5 detail_tap pull_left select">满意度销售顾问</li>
...
<div class="frmTitle" onclick="showOrHiden('contactTable')">${monthDate }月回访报表考核个人</div>
