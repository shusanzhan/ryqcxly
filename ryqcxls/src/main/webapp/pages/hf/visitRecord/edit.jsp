...
<div class="frmContent" >
	...
	<input type="hidden" name="visitRecord.dbid" id="dbid" value="${visitRecord.dbid }">
		...
		<table class="" border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;">
			<tr height="42">
	...
	<div class="formButton">
		<a href="javascript:void(-1)"	onclick="$.utile.submitForm('frmId','${ctx}/visitRecord/save')"	class="but butSave">保存回访记录</a> 
