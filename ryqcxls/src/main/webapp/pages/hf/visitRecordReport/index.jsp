...
<div class="main-content" style="min-height: 520px;">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a href="javascript:void(-1)">回访月报</a>
						</li>
					</ul><!-- /.breadcrumb -->
				</div>
				<!-- /section:basics/content.breadcrumbs -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="bootbox-form" >
					...
					<input class="bootbox-input bootbox-input-text form-control" id="monthDate" name="monthDate" value="${monthDate }" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM'})" >
				</form>
				</div>
			</div>
...
function sbmt(){
	...
	window.location.href='${ctx}/visitRecordReport/monthReport?brandId='+brandId+'&monthDate='+monthDate;
}
</script>
