...
<div id="detail_nav">
	<div class="detail_nav_inner">
	      <ul class="clearfix padding10">
	        <li onclick="window.location.href='${ctx }/visitRecordReport/viewMonthReport?visitRecordReportId=${visitRecordReport.dbid }'" id="imgs_tap" class="detail_tap5 detail_tap pull_left select">满意度销售顾问</li>
	        ...
	        <li onclick="window.location.href='${ctx }/visitRecordReport/viewMonthReportUser?visitRecordReportId=${visitRecordReport.dbid }'" id="pingjia_tap" class="detail_tap5 detail_tap pull_left ">满意度部门负责人</li>
...
<div class="frmTitle" onclick="showOrHiden('contactTable')">${monthDate }月${brand.name }回访报表考核个人</div>
<table width="100%"  cellpadding="0" cellspacing="0" class="mainTable" border="0">
	<thead  class="TableHeader">
		<tr>
			<td class="span1">序号</td>
			<td class="span3">销顾问</td>
	...
	<c:forEach var="visitRecordReportItem" items="${visitRecordReportItems}" varStatus="i">
		<tr height="32" align="center">
			<td>${i.index+1 }</td>
			<td>${visitRecordReportItem.userName }</td>
