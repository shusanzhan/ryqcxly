...
<div id="detail_nav">
	<div class="detail_nav_inner">
	      <ul class="clearfix padding10">
	        ...
	        <li onclick="window.location.href='${ctx }/visitRecordReport/viewMonthReportDep?visitRecordReportId=${visitRecordReport.dbid }'" id="pingjia_tap" class="detail_tap5 detail_tap pull_left select">满意度部门</li>
