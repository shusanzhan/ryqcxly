...
<div id="detail_nav">
	<div class="detail_nav_inner">
	      <ul class="clearfix padding10">
	        ...
	        <li onclick="window.location.href='${ctx }/visitRecordReport/viewMonthReportDepDetail?visitRecordReportId=${visitRecordReport.dbid }'" id="pingjia_tap" class="detail_tap5 detail_tap pull_left select">核心流程</li>
	   	</ul>
	 </div>
</div>
