...
<div id="detail_nav">
	<div class="detail_nav_inner">
	      <ul class="clearfix padding10">
	        ...
	        <li onclick="window.location.href='${ctx }/visitRecordReport/viewMonthReportSale?visitRecordReportId=${visitRecordReport.dbid }'" id="pingjia_tap" class="detail_tap5 detail_tap pull_left select">自有店</li>
