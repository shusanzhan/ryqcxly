	...
	<form action="" name="frmId" id="frmId"  target="_self">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;margin-top: 5px;">
				...
				<tr style="height: 40px;" height="40">
					...
					<td colspan="" >
						<input type="text" readonly="readonly" name="insuranceRecord.incidentalInterestMoney"  id="incidentalInterestMoney" value="0.0" class="large text">
						<span style="color: red;">*</span>
					</td>
				...
				<tr style="height: 40px;" height="40">
					...
					<td colspan="" style="font-size: 10px;">
						...
						返利合计:<span id="strongRiskPerText">强制险*%</span>+<span id="busiRiskPerText">商业险*%</span>=<span style="font-size: 20px;color: red;margin:0 5px;" id="rebateMoneyText">0</span>元
					</td>
				...
				<tr style="height: 40px;" height="40">
					...
					<td colspan="1"><input type="text" class="large text"  name="insuranceRecord.saler" id="saler" onfocus="autoUser('saler')"	value="${insCustomer.customer.user.realName }" checkType="string,1,50"  tip="起保日期日期不能为空"></td>
			...
			<table id="shopNumber" border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;margin-top: 5px;">
					...
					<c:if test="${empty(insCustomer) }">
						<c:forEach var="i" begin="0" step="1" end="3">
							<tr id="tr${i+1 }">
								...
								<td style="text-align: center;">
									<input type="text"  name="price" id="price${i+1 }" class="large text"   onkeyup="decorePrice();getTotalPrice();" checkType="integer,1" canEmpty="Y" tip="请输入项目价值，必须为数字" style="width: 95%">
								</td>
								<td>
					...
					<c:if test="${!empty(insCustomer) }">
						...
						<c:forEach var="insuranceIncidentalInterest" items="${insuranceIncidentalInterests }" varStatus="i">
							<tr id="tr${i.index+1 }">
								...
								<td >
									<input type="text" name="incidentalInterestName" id="incidentalInterestName${i.index+1 }" value="${insuranceIncidentalInterest.incidentalInterest.name }" onFocus="autoIncidentalInterestByName('incidentalInterestName${i.index+1 }');create(this)"  style="width: 100%;">
								...
								<td style="text-align: center;">
									<input type="text"  name="price" id="price${i.index+1 }" value="${insuranceIncidentalInterest.price }" onkeyup="decorePrice();getTotalPrice();" checkType="integer,1" canEmpty="Y" tip="请输入项目价值，必须为数字" style="width: 95%">
								</td>
								<td>
									<input type="text" name="note" id="note${i.index+1 }" style="width: 92%;" value="${insuranceIncidentalInterest.note }" checkType="string,1" canEmpty="Y" tip="请输入项目备注信息" style="width: 95%">
								</td>
								<td style="text-align: center;padding-top: 8px;">
									<a class="aedit" href="javascript:void(-1)" onclick="deleteTr(this)" >
										<i class="icon-remove icon-black" > </i>
				...
				<tr height="32" style="background-color: #eeeeee; border-color:#eeeeee;font-size: 16px;font-weight: bold;">
					<td width="100%" colspan="5" style="text-align: right;padding-right: 12px;">客户权益合计：<span style="font-size: 20px;color: red;margin:0 5px;" id="incidentalInterestMoneyText">0</span>元</td>
				</tr>
			</table>
		</div>
	</form>
...
function crateTr() {
	...
	var str = ' <tr id="tr'+size+'">'
			...
			+ '</td>'
			+ '<td  style="text-align: center;">'
				+ '<input  type="text"  name="price" id="price'+size+'" class="large text" checkType="integer,1" onkeyup="decorePrice();getTotalPrice();" canEmpty="Y" tip="请输入项目价值，必须为数字" style="width: 95%;" >'
			+ '</td>'
			+ '<td style="text-align: center;">'
