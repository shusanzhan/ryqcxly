...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="window.location.href='${ctx}/insStatical/index'">统计分析</a>
</div>
<div class="row-fluid" >
	  	<div class="seracrhOperate" style="float: left;">
	  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/insStatical/insuranceInfromStatical" method="post" >
...
<div class="row-fluid">
	<div class="span6">
		<div class="widget-box">
			<div id="container" style=" height: 300px; max-width: 1200px; margin: 0 auto"></div>
		</div>
	</div>
	<div class="span6">
		<div class="widget-box">
			<div id="container1" style="height: 300px; max-width: 1200px; margin: 0 auto"></div>
		</div>
	</div>
</div>
