	...
	<form action="" name="frmId" id="frmId"  target="_self">
					...
					<!-- 编辑时展示页面 结束 -->
						...
						<c:forEach var="decoreOutProduct" items="${decoreOutProducts }" varStatus="i">
							<tr>
								...
								<td id="brand${i.index+1 }" style="text-align: center;">
									${decoreOutProduct.product.brand.name }
								</td>
								<td style="text-align: center;">
						...
						<c:forEach var="i" begin="${itemLength }" step="1" end="7">
							<tr id="tr${i+1 }">
								...
								<td >
									<input type="text" readonly="readonly" name="productName" id="productName${i+1 }" value="${decoreOutProduct.product.name }" class="media text" >
								</td>
								<td style="text-align: center;">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;margin-top: 12px">
			<tr height="42">
				...
				<td >
					<c:if test="${empty(decoreOut) }">
						<input type="text" readonly="readonly" name="decoreOut.zkl" id="zkl" onkeyup="disMoneyDis(this.value)" value="100" class="largeX text" title="折扣率" placeholder="100"	checkType="float,1" tip="折扣率不能为空">%<span style="color: red;">*</span>
					</c:if>
					<c:if test="${!empty(decoreOut) }">
						<input type="text" readonly="readonly" name="decoreOut.zkl" id="zkl" onkeyup="disMoneyDis(this.value)" value="${decoreOut.zkl }" class="largeX text" title="折扣率" placeholder="100"	checkType="float,1" tip="折扣率不能为空">%<span style="color: red;">*</span>
					</c:if>
				</td>
				<td class="formTableTdLeft">折扣后金额:&nbsp;</td>
				<td>
					<c:if test="${empty(decoreOut) }">
						<input type="text" readonly="readonly" name="decoreOut.disMoney" id="disMoney" value="0" class="largeX text" title="折扣后金额" checkType="float,1" tip="折扣后金额不能为空"><span style="color: red;">*</span>
					</c:if>
					<c:if test="${!empty(decoreOut) }">
						<input type="text" readonly="readonly" name="decoreOut.disMoney" id="disMoney" value="${decoreOut.disMoney }" class="largeX text" title="折扣后金额" checkType="float,1" tip="折扣后金额不能为空"><span style="color: red;">*</span>
					</c:if>
				</td>
			</tr>
			<tr height="42">
				...
				<td colspan="">
					<input type="text" readonly="readonly" name="decoreOut.costTotalPrice" id="costTotalPrice" value="${decoreOut.costTotalPrice}"  placeholder="0.0" class="largeX text" title="成本总额"	checkType="float,1" tip="成本总额"><span style="color: red;">*</span>
				</td>
				<td class="formTableTdLeft">顾问结算总额:&nbsp;</td>
				<td >
					<input type="text" readonly="readonly" name="decoreOut.salerTotalPrice" id="salerTotalPrice" value="${decoreOut.salerTotalPrice }" placeholder="0.0" class="largeX text" title="顾问结算总额"	checkType="float,1" tip="顾问结算总额"><span style="color: red;">*</span>
				</td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">实收金额:&nbsp;</td>
				<td colspan="">
					<input type="text" readonly="readonly" name="decoreOut.acturePrice" id="acturePrice" value="${decoreOut.acturePrice }"  placeholder="0.0" class="largeX text" title="本次付款金额"	checkType="float,1" tip="本次付款金额">
			...
			<tr height="42">
				...
				<td ><input type="text" readonly="readonly" name="decoreOut.customerName" id="customerName" value="${decoreOut.customerName }" class="largeX text" title="客户姓名"	checkType="string,1,7" canEmpty="Y" tip="客户姓名"></td>
				<td class="formTableTdLeft">联系电话:&nbsp;</td>
				<td ><input type="text" readonly="readonly" name="decoreOut.mobilePhone" id="mobilePhone" value="${decoreOut.mobilePhone }" class="largeX text" title="联系电话"	checkType="mobilePhone" canEmpty="Y" tip="联系电话可为空"></td>
			</tr>
			<tr>
				<td class="formTableTdLeft">销售人员:&nbsp;</td>
				<td colspan="3">
					<input type="text" readonly="readonly" name="decoreOut.saler" id="saler" value="${decoreOut.saler }"  placeholder="" class="largeX text" title="销售人员"	checkType="string,1" tip="销售人员不能为空">
					<span style="color: red;">*</span>
				</td>
			</tr>
			<tr height="32">
				...
				<td colspan="3">
					<textarea readonly="readonly" name="decoreOut.note" id="note" title="内容简介"  class="largeXX text" style="height: 40px;width: 720px;">${decoreOut.note }</textarea>
				</td>
			</tr>
		</table>
	</form>
