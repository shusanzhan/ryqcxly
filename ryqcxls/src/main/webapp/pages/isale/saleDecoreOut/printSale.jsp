	...
	<form action="" name="frmId" id="frmId" style="margin-bottom: 40px;" target="_parent">
	    ...
	    <tbody>
	        ...
	        <tr height="20" style=";height:28px;" class="noneLine">
	            ...
	            <td colspan="5" width="60"  style="border-bottom: 1px solid #000;font-size: 18px;font-weight: bold;">
	                ${decoreOut.outNo}
	            </td>
	        </tr>
	          <tr height="22" style=";height:22px">
	            ...
	            <td colspan="3" width="181" style="border-left-style: none;">
	          ...
	          <tr height="22" style=";height:22px">
	            ...
	            <td colspan="5" width="181" style="border-left-style: none;">
            ...
            <td align="center" colspan="1" width="96" style="border-left-style: none;">
                编号
            </td>
            <td align="center" colspan="4" width="80" style="border-left-style: none;">
                项目
            </td>
            ...
            <td align="center" colspan="2" width="76" style="border-left-style: none;">
                金额
            </td>
        </tr>
        ...
        <c:if test="${status==false }">
        	<c:forEach var="decoreOutProduct" items="${decoreOutProducts }" varStatus="in">
       			<tr height="16" style=";height:16px">
		            ...
		            <td colspan="1" style="border-top:none;border-left:none">
		            ...
		            <td align="right" style="border-top:none;border-left:none">
		            	<fmt:formatNumber value="${decoreOutProduct.salerPrice }" pattern="#.00"></fmt:formatNumber> 
		            </td>
		            <td align="right" style="border-top:none;border-left:none">
		            	<fmt:formatNumber value="${decoreOutProduct.purchasePrice }" pattern="#.00"></fmt:formatNumber> 
		            </td>
		     
		            <td align="right" colspan="2" style="border-left:none">
        ...
        <tr height="16" style=";height:16px">
            <td  colspan="11" align="right" height="16" style="border-top-style: none; border-left-style: none;">
            合计:
            </td>
            <td colspan="1" style="border-left:none">
		...
		<c:if test="${decoreOut.copyStatus==1 }">
			<tr height="32" style=";height:32px">
	            ...
	            <td style="border-top:none;border-left:none" colspan="">
		...
		<c:if test="${decoreOut.copyStatus==2 }">
			<tr height="32" style=";height:32px">
				 <td align="right" colspan="8" style="border-top:none">
	                顾问结算总额
	            </td>
	            <td style="border-top:none;border-left:none" colspan="">
	            	${decoreOut.salerTotalPrice }
	            </td>
	            <td align="right" colspan="" style="border-top:none">
	                成本合计
	            </td>
