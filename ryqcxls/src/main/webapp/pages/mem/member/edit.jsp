		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				...
				<td ><input type="text" name="member.name" id="name"
					value="${member.name }" class="largeX text" title="名称" placeholder="请输入客户名称"	checkType="string,1,50" tip="名称不能为空"><span style="color: red;">*</span></td>
			...
			<tr height="42">
				...
				<td ><input type="text" name="member.mobilePhone" id="mobilePhone"
					value="${member.mobilePhone }" class="largeX text" placeholder="请输入常用手机号" title="常用手机号"	checkType="mobilePhone" tip="常用手机号不能为空"><span style="color: red;">*</span></td>
			...
			<tr height="42">
				...
				<td ><input type="text" readonly="readonly" name="member.microId" id="microId"	value="${member.microId }" class="largeX text" title="微信号"	></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">车型:&nbsp;</td>
				<td >
					<input type="text" readonly="readonly" name="member.car" id="car"	value="${member.car }" class="largeX text" title="微信号"	>
				</td>
			...
			<tr height="42">
				...
				<td ><input type="text" name="member.carNo" id="carNo"	value="${member.carNo }" class="largeX text"   title="车牌号"	></td>
