	...
	<form action="" name="frmId" id="frmId"  target="_self">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			...
			<tr height="32">
				...
				<td>
					<textarea class="text textarea" rows="8" cols="60" name="spread.note" id="note" checkType="string,1,200" canEmpty="Y" tip="请控制在200字以内" placeholder="请控制在200字以内">${spread.note }</textarea>
				</td>
			</tr>
		</table>
	</form>
