		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			...
			<tr height="42">
				...
				<td ><input type="text" name="spreadDetail.name" id="name"
					value="${spreadDetail.name }" class="largeX text" title="名称" onfocus="autoCompany('name')"	checkType="string,2,12" tip="长度在2到12个字符之间，不能与已有渠道重复"><span style="color: red;">*</span>
