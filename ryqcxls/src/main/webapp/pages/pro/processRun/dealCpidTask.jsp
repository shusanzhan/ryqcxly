...
<div class="location">
   	...
   	<a href="javascript:void(-1);" >合同流失审批</a>
</div>
<div class="line"></div>
<br>
<div class="formButton" style="margin-bottom: 12px;padding-left: 5px;width: 100%;">
	<c:if test="${user.approvalCpidStatus==2 }">
		<a href="javascript:void(-1)" id="sbmId"	onclick="$('#approvalStatus').val('3');$.utile.submitAjaxForm('frmId','${ctx}/processRun/saveDealTask')"	class="but butSave">同&nbsp;&nbsp;意</a> 
	</c:if>
...
<div class="frmContent">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;">
			<tr height="42" style="background-color: #eeeeee; border-color:#eeeeee;font-size: 16px;font-weight: bold;">
					<td width="100%" colspan="4" style="">流失原因</td>
			</tr>
			<tr height="42">
			...
			<c:forEach var="customerPidCancel" items="${customerPidCancels }" varStatus="i">
				<tr height="42">
					<td class="formTableTdLeft">流失原因${i.index+1 }:&nbsp;</td>
					<td id="carModelLabel" colspan="3">
						 流失原因：${customerPidCancel.customerpidFlowReason.name }
							<br>
						 流失备注：${customerPidCancel.note }
					</td>
				</tr>
			</c:forEach>
		</table>
