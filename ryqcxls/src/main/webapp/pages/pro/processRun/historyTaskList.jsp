...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="">经我审批</a>
</div>
 <!--location end-->
<div class="line"></div>
<div class="listOperate">
	<div class="operate">
  	...
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm" action="${ctx}/processRun/queryHistoryTaskList" method="post">
		<input type="hidden" id="currentPage" name="currentPage" value='${page.currentPageNo}'>
		<input type="hidden" id="paramPageSize" name="pageSize" value='${page.pageSize}'>
			<table cellpadding="0" cellspacing="0" class="searchTable" >
				<tr>
					<td><label>审批类型：</label></td>
	  				<td>
 ...
 <c:if test="${empty(page)||fn:length(page.result)<=0 }" var="status">
 	<div class="alert alert-error">无经我审批记录</div>
 </c:if>
...
<table width="100%"  cellpadding="0" cellspacing="0" class="mainTable" border="0">
	...
	<c:forEach var="processFrom" items="${page.result }">
		...
		<tr height="32" align="center">
			...
			<td>
				<a href="javascript:void(-1)" class="aedit" onclick="window.location.href='${ctx }/processRun/viewProcessFrom?processRunDbid=${processRun.dbid}'">审批记录</a>
