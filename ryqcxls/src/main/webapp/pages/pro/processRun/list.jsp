...
<div class="listOperate">
	<div class="operate">
  	...
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm" action="${ctx}/processRun/queryList" method="post">
			...
			<table cellpadding="0" cellspacing="0" class="searchTable" >
				<tr>
					<td><label>申请类型：</label></td>
	  				...
	  				<td>
	  					<select class="small text" id="runStatus" name="runStatus" onchange="$('#searchPageForm')[0].submit()" >
...
<table width="100%"  cellpadding="0" cellspacing="0" class="mainTable" border="0">
	<thead  class="TableHeader">
		<tr>
			...
			<td class="span1">审批人</td>
			<td class="span2">操作</td>
		</tr>
	</thead>
	<c:forEach var="processRun" items="${page.result }">
		...
		<tr height="32" align="center">
			...
			<td style="text-align: center;">
				${processRun.approvalUser.realName }
			</td>
			<td>
				<a href="#" class="aedit" onclick="window.location.href='${ctx }/processRun/viewProcessFrom?processRunDbid=${processRun.dbid}'">审批记录</a>
				<c:if test="${processRun.runStatus==1 }">
					|
					<a href="#" class="aedit" onclick="$.utile.operatorDataByDbid('${ctx }/processRun/sendWarmingMessage?processRunId=${processRun.dbid}','searchPageForm','确定给【${processRun.approvalUser.realName  }】发送催办信息吗？')">催办</a>
				</c:if>
		</tr>
	</c:forEach>
</table>
