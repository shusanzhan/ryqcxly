...
<div class="views content_title">
    ...
    <span id="page_title">${brand.name }库存查询</span>
...
<c:if test="${fn:length(carSerCounts)>0 }" var="status">
	<c:forEach var="carSerCount" items="${carSerCounts }">
	  <li class="list-group-item" onclick="window.location.href='${ctx}/qywxFacotoryOrder/carModelList?carSeriyId=${carSerCount.serid }'">
