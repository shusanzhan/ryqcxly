...
<title>${carModel.name }库存查询</title>
<style type="text/css">
body {
...
<div class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">${carModel.name }</span>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxFacotoryOrder/factoryOrderList?carModelId=${param.carModelId}" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr height="">
      	 		<td width="60"><label for="exampleInputName2">原始进货商</label></td>
      	 		<td width="240">
	      	 		<select class="form-control" id="enterpriseId" name="enterpriseId">
			    	<option value="">请选择...</option>
			    	<c:forEach var="enterprise" items="${enterprises }">
				    	<option value="${enterprise.dbid }" ${param.enterpriseId==enterprise.dbid }>${enterprise.name }</option>
			    	</c:forEach>
			    </select>
			    </td>
      	 	</tr>
