...
<br>
    <div class="weui_btn_area" style="position: fixed;left: 0;bottom:12px;width: 100%;">
        <a class="weui_btn weui_btn_warn" href="javascript:" id="showTooltips" onclick="if(validateFrm()){ajaxSubmit('${ctx}/qywxCustomer/saveComeShopingRecordSuccess','frmId')}">保存</a>
    </div>
