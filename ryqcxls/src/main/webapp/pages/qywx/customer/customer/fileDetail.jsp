...
<div class="orderContrac detail">
	<div class="title" align="left">
		...
		<c:if test="${customer.lastResult!=1 }" var="status">
			<span><a href="${ctx }/qywxCustomerFile/cardInfo?dbid=${customer.dbid}&type=1">修改完善</a></span>
		</c:if>
	</div>
	<div class="line"></div>
	<div style="margin: 0 auto;margin: 5px;">
...
<div class="orderContrac detail">
	<div class="title" align="left">
		<span>档案信息</span>
		<span><a href="${ctx }/qywxCustomerFile/customerFile?dbid=${customer.dbid}">修改完善</a></span>
	</div>
	<div class="line"></div>
	<div style="margin: 0 auto;margin: 5px;">
		<div style="color:#8a8a8a;padding-left: 5px; ">
...
<div class="orderContrac detail">
	<div class="title" align="left">
		<span>来店登记</span>
		<span><a href="${ctx }/qywxCustomerFile/customerShoppingRecord?dbid=${customer.dbid}">修改完善</a></span>
	</div>
	<div class="line"></div>
	<div style="margin: 0 auto;margin: 5px;">
		<div style="color:#8a8a8a;padding-left: 5px; ">
...
<div class="orderContrac detail">
	<div class="title" align="left">
		<span>需求评估</span>
		<span><a href="${ctx }/qywxCustomerFile/customerBussiNeed?dbid=${customer.dbid}">修改完善</a></span>
	</div>
	<div class="line"></div>
	<div style="margin: 0 auto;margin: 5px;">
		<div style="color:#8a8a8a;padding-left: 5px; ">
...
<div class="orderContrac detail">
	<div class="title" align="left">
		<span>接待结果</span>
		<span><a href="${ctx }/qywxCustomerFile/customerBussi?dbid=${customer.dbid}">修改完善</a></span>
	</div>
	<div class="line"></div>
	<div style="margin: 0 auto;margin: 5px;">
		<div style="color:#8a8a8a;padding-left: 5px; ">
			...
			<c:if test="${!empty(approvalRecords) }">
				<c:forEach var="approvalRecord" items="${approvalRecords }">
					    	...
					    	<c:if test="${approvalRecord.result==1 }">
								<span style="color: #DD9A4B;">等待经理审批</span>
							</c:if>
							<c:if test="${approvalRecord.result==2 }">
								<span style="color: red;">审批驳回</span>
							</c:if>
							<c:if test="${approvalRecord.result==3 }">
								<span style="color: blue;">审批同意</span>
							</c:if>
