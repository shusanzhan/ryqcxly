...
<input  type="hidden"  class="weui_input" id="bussiStaff" name="customer.bussiStaff"   value="${customer.bussiStaff }">
<div class="navbar">
	<div class="bd" style="height: 100%;">
			...
			<div class="weui_cells weui_cells_form">
			        <div class="weui_cell">
			         ...
			         <div class="weui_cell">
			            ...
			            <div class="weui_cell_bd weui_cell_primary">
			               <c:if test="${customer.orderContract.status>=1}" var="status">
							  <input type="number" re class="weui_input" id="mobilePhone" name="customer.mobilePhone" pattern="[0-9]*" placeholder="请输入号码" checkType="mobilePhone" value="${customer.mobilePhone }">
						  </c:if>
						  <c:if test="${status==false }">
	               ...
	               <c:if test="${customer.lastResult==1 }" var="status">
			            ...
			            <div class="weui_cell_bd weui_cell_primary">
								...
								${customerBussi.brand.name }${customerBussi.carSeriy.name }${customerBussi.carModel.name }
			            </div>
			        </div>
	               </c:if> 
	               <c:if test="${status==false }">
        ...
        <div class="weui_tab_bd">
			...
			<div class="weui_cells weui_cells_form">
				 <div class="weui_cell">
            		<div class="weui_cell_hd">
		            	<label class="weui_label" style="width: 80px;">进店时间</label>
		            </div>
		            <div class="weui_cell_bd weui_cell_primary">
			            <c:if test="${empty(customerShoppingRecord.comeInTime) }">
							<input type="text" name="customerShoppingRecord.comeInTime" id="comeInTime" value="${customerRecord.comeInTime }" class="weui_input" 	onfocus="WdatePicker({readOnly:true,dateFmt:'HH:mm'});"  >
						</c:if>
						<c:if test="${!empty(customerShoppingRecord.comeInTime) }">
							<input type="text" name="customerShoppingRecord.comeInTime" id="comeInTime" value="${customerShoppingRecord.comeInTime }" class="weui_input" 	onfocus="WdatePicker({readOnly:true,dateFmt:'HH:mm'});"  >
						</c:if>
		            </div>
		        </div>
				 <div class="weui_cell">
			   ...
			   <c:if test="${customer.tryCarStatus==2 }">
			    ...
			    <div class="weui_cell">
		            ...
		            <div class="weui_cell_bd weui_cell_primary">
						<input name="customerShoppingRecord.tryDriver"  id="tryDriver"  value="${customerShoppingRecord.tryDriver }" class="weui_input" ></input>
		            </div>
		        </div>
			    <div class="weui_cell">
            		<div class="weui_cell_hd">
		            ...
		            <div class="weui_cell_bd weui_cell_primary">
						<input  type="text" class="weui_input" id="carModel" name="customerShoppingRecord.carModel"   value="${customerShoppingRecord.carModel }">
		            </div>
		        </div>
    ...
    <div class="weui_tab_bd">
			...
			<div class="weui_cells weui_cells_form">
		         <div class="weui_cell weui_cell_select weui_select_after">
		            ...
		            <div class="weui_cell_bd weui_cell_primary">
						<select id="paperworkId" name="paperworkId" class="weui_select">
							<option value="">请选择...</option>
		      ...
		      <div class="weui_cell">
            		<div class="weui_cell_hd">
		            	<label class="weui_label" style="width: 80px">证件号码</label>
		            </div>
		            <div class="weui_cell_bd weui_cell_primary">
						<input type="text"  class="weui_input" name="customer.icard" id="icard"  value="${customer.icard }" onkeyup="getBirthday(this.value,'nbirthday')"/>	
		            </div>
		      </div>
		      <div class="weui_cell">
            		<div class="weui_cell_hd">
		            	<label class="weui_label" style="width: 80px">生日</label>
		            </div>
		            <div class="weui_cell_bd weui_cell_primary">
						<input type="text" class="weui_input" name="customer.nbirthday" onmouseout="" onFocus="WdatePicker({isShowClear:false,readOnly:true});getBirthdayAge(this.value,'age')" id="nbirthday"  value="<fmt:formatDate value="${customer.nbirthday }"/>" />	
		            </div>
		      </div>
		      <div class="weui_cell">
            		<div class="weui_cell_hd">
		            	<label class="weui_label" style="width: 80px">年龄</label>
		            </div>
		            <div class="weui_cell_bd weui_cell_primary">
						<input type="text"   class="weui_input" name="customer.age" id="age"   value="${customer.age }" placeholder="填写生日自动生成"/>	
		            </div>
		      </div>
		      <div class="weui_cell">
            		<div class="weui_cell_hd">
		            	<label class="weui_label" style="width: 80px">单位信息</label>
		            </div>
		            <div class="weui_cell_bd weui_cell_primary">
						<input name="customer.companyName1"  class="weui_input" id="companyName1" title="单位信息"  value="${customer.companyName1 }" ></input>	
		            </div>
		      </div>
		      <div class="weui_cell">
            		<div class="weui_cell_hd">
		            	<label class="weui_label" style="width: 80px">家庭情况</label>
		            </div>
		            <div class="weui_cell_bd weui_cell_primary">
						<input  type="text" class="weui_input" id="family" name="customer.family"   value="${customer.family }">	
		            </div>
		      </div>
		      <div class="weui_cell">
            		<div class="weui_cell_hd">
		            	<label class="weui_label" style="width: 80px">QQ/MSN</label>
		            </div>
		            <div class="weui_cell_bd weui_cell_primary">
						<input type="text"   class="weui_input" name="customer.qq" id="qq" value="${customer.qq }" checkType="qq" canEmpty="Y" >	
		            </div>
		      </div>
		      <div class="weui_cell">
            		<div class="weui_cell_hd">
		            	<label class="weui_label" style="width: 80px">EMAIL</label>
		            </div>
		            <div class="weui_cell_bd weui_cell_primary">
						<input  type="text" id="email" class="weui_input" name="customer.email"  checkType="email" canEmpty="Y"  value="${customer.email }">	
		            </div>
		      </div>
		      <div class="weui_cell">
            		<div class="weui_cell_hd">
		            	<label class="weui_label" style="width: 80px">邮编</label>
		            </div>
		            <div class="weui_cell_bd weui_cell_primary">
						<input type="text"  class="weui_input" name="customer.zipCode" id="zipCode" checkType="zipCode" canEmpty="Y" tip="请输入邮编,可以为空,邮编格式如：600101"  value="${customer.zipCode }" />	
		            </div>
		      </div>
		      <div class="weui_cell weui_cell_select weui_select_after">
	            <div class="weui_cell_hd" >
	            ...
	            <div class="weui_cell_bd weui_cell_primary">
					<select id="industryId" name="industryId" class="weui_select">
						<option value="">请选择...</option>
		      ...
		      <div class="weui_cell weui_cell_select weui_select_after">
	            ...
	            <div class="weui_cell_bd weui_cell_primary">
					<select id="professionId" name="professionId" class="weui_select">
						<option value="">请选择...</option>
		      ...
		      <div class="weui_cell weui_cell_select weui_select_after">
	            ...
	            <div class="weui_cell_bd weui_cell_primary">
					<select id="educationalId" name="educationalId" class="weui_select">
						<option value="">请选择...</option>
...
<br>
    <div class="weui_btn_area" style="position: fixed;left: 0;bottom:12px;width: 100%;">
        <a class="weui_btn weui_btn_warn" href="javascript:" id="showTooltips" onclick="ajaxSubmit('${ctx}/qywxCustomer/saveEdit','frmId')">保存</a>
    </div>
