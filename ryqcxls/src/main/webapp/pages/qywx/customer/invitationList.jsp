...
<div class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">我的邀约客户</span>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxCustomer/queryInvitationList" name="searchPageForm" id="searchPageForm" method="post">
      	 ...
      	 <table>
      	 	...
      	 	<tr>
      	 		<td width="60"><label for="exampleInputName2">谈判人：</label></td>
