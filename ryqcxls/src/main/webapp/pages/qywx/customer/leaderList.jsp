  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxCustomer/leaderList" name="searchPageForm" id="searchPageForm" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="searchTable" >
  			...
  			<tr>
  				...
  				<td>
  					<select class="form-control" id="lastResult" name="lastResult"  onchange="$('#searchPageForm')[0].submit()">
  			...
  			<tr>
  				...
  				<td>
  					<select class="form-control" id="bussiStaffId" name="bussiStaffId"  onchange="$('#searchPageForm')[0].submit()">
						<option value="-1" >请选择...</option>
  			...
  			<tr>
  				...
  				<td>
  					<input type="date" class="form-control" id="startTime" name="startTime" onFocus="WdatePicker({isShowClear:true,readOnly:true})" value="${param.startTime }" >
				</td>
			</tr>
  			<tr>
  				<td><label>结束时间：</label></td>
  				<td>
  					<input type="date" class="form-control" id="endTime" name="endTime" onFocus="WdatePicker({isShowClear:true,readOnly:true})" value="${param.endTime }">
  				</td>
  			</tr>
  			<tr>
  				<td><label>试驾开始：</label></td>
  				<td>
  					<input type="date" class="form-control" id="tryCarStartTime" name="tryCarStartTime" onFocus="WdatePicker({isShowClear:true,readOnly:true})" value="${param.tryCarStartTime }" >
				</td>
			</tr>
  			<tr>
  				<td><label>结束时间：</label></td>
  				<td>
  					<input type="date" class="form-control" id="tryCarEndTime" name="tryCarEndTime" onFocus="WdatePicker({isShowClear:true,readOnly:true})" value="${param.tryCarEndTime }">
  				</td>
  			</tr>
  			<tr>
  				<td><label>来店开始：</label></td>
  				<td>
  					<input type="date" class="form-control" id="comeShopStartTime" name="comeShopStartTime" onFocus="WdatePicker({isShowClear:true,readOnly:true})" value="${param.comeShopStartTime }" >
				</td>
			</tr>
  			<tr>
  				<td><label>结束时间：</label></td>
  				<td>
  					<input type="date" class="form-control" id="comeShopEndTime" name="comeShopEndTime" onFocus="WdatePicker({isShowClear:true,readOnly:true})" value="${param.comeShopEndTime }">
  				</td>
  			</tr>
      	 </table>
		</form>
