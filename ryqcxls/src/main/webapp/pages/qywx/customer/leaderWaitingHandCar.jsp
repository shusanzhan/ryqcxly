...
<c:if test="${status==false }">
	<div class="orderContrac">
		<div class="title" align="left">
			${empty(param.startDate)==true?'今日':''}无发起交车客户<span style="color: red;font-size: 20px;">${dayCustomerNum}</span>
			<br>
			<p>默认只查询当天发起交车客户,您可以通过条件选择查询更多数据</p>
			<p>待交车客户不包含成交客户（归档客户）</p>
		</div>
	</div>
	<br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxCustomer/queryLeaderWaitingHandCar" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr height="">
      	 	...
      	 	<tr>
      	 		<td width="60"><label for="exampleInputName2">交车日期开始</label></td>
      	 		<td width="240">
      	 			<input type="date" class="form-control" id="startDate" name="startDate" value="${param.startDate }">
			    </td>
      	 	</tr>
      	 	<tr>
      	 		<td width="60"><label for="exampleInputName2">交车日期结束</label></td>
      	 		<td width="240">
