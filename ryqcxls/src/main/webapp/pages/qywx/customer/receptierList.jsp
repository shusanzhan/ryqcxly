...
<div class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">我的接待客户</span>
...
<br>
<div class="buttomBar">
    <a name="mobileCommit" href="${ctx }/qywxCustomer/receptier" id="tele_register" class="addbutton" onclick=")">谈判登记</a>
</div>
<br>
<br>
<br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxCustomer/queryReceptierList" name="searchPageForm" id="searchPageForm" method="post">
