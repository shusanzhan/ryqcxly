...
<div class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">登记客户需次日回访记录</span>
...
<br>
<br>
<c:if test="${empty(dayCustomers)||fn:length(dayCustomers)<=0 }" var="status">
	您还未添加客户！
</c:if>
<c:if test="${status==false }">
	<div class="orderContrac">
		<div class="title" align="left">
			次日需回访客户总数：<span style="color: red;font-size: 20px;">${dayCustomerNum}</span>
		</div>
	</div>
	<br>
	<c:forEach items="${dayCustomers }" var="customerTrack">
