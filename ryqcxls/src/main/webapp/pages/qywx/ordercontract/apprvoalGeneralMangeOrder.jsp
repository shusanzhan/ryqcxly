...
<div class="views content_title navbar-fixed-top">
    ...
    <a class="go_home" href="${ctx }/qywxOrderContract/generalManageApprovalOrder">
...
<div class="orderMenu">
	<ul>
         <li>
             <a href="javascript:void(-1)"  data-toggle="modal" data-target="#exampleModal" onclick="setVal(5)">
             	不同意
             </a>
         </li>
         <li>
             <a href="javascript:void(-1)" id="agreeActive" data-toggle="modal" data-target="#exampleModal" onclick="setVal(6)">
             	同意
             </a>
         </li>
      </ul>
