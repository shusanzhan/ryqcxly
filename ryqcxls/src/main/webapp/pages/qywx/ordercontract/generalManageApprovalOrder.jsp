...
<title>订单审批（总经理）</title>
</head>
<body>
<div class="views content_title navbar-fixed-top">
    <span id="page_title">订单审批</span>
</div>
<br>
<br>
<br>
...
<c:if test="${status==false }">
	<c:forEach items="${orderContracts }" var="orderContract">
		...
		<div class="orderContrac" onclick="window.location.href='${ctx}/qywxOrderContract/apprvoalGeneralMangeOrder?dbid=${orderContract.dbid }'">
...
<div class="oneMenu">
	<ul>
         <li>
             <a href="${ctx}/qywxOrderContract/generalManageApprovalOrder">
             	待我审批
             </a>
