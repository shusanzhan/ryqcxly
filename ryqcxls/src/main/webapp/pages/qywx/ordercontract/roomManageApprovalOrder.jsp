...
<c:if test="${status==false }">
	<c:forEach items="${orderContracts }" var="orderContract">
		...
		<div class="orderContrac" onclick="window.location.href='${ctx}/qywxOrderContract/apprvoalRoomMangeOrder?dbid=${orderContract.dbid }'">
...
<div class="oneMenu">
	<ul>
         <li>
             <a href="${ctx}/qywxOrderContract/roomManageApprovalOrder">
             	待我审批
             </a>
