...
<c:if test="${status==false }">
	<c:forEach items="${orderContracts }" var="orderContract">
		...
		<div class="orderContrac" onclick="window.location.href='${ctx}/qywxOrderContract/apprvoalOrder?dbid=${orderContract.dbid }'">
...
<div class="oneMenu">
	<ul>
         <li>
             <a href="${ctx}/qywxOrderContract/saleManageApprovalOrder">
             	待我审批
             </a>
