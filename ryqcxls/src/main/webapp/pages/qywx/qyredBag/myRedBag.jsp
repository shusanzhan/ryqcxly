...
<div id="hearder_nav" class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">${monthDay }月红包记录</span>
...
<div class="row-fluid">
	<table class="table table-bordered table-striped">
		<tbody>
			<tr>
				<td align="center" width="40">个数</td>
				<td align="center" width="40">总额</td>
			</tr>
			<tr>
...
<div class="row-fluid">
	...
	<c:if test="${!empty(redBags) }">
		<table class="table table-bordered table-striped">
			<tbody>
				<tr>
					<td align="center" width="40">活动</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxRedBag/myRedBag" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr>
