...
<c:if test="${status==false }">
	<c:forEach items="${customers }" var="customer">
		...
		<div class="orderContrac" onclick="window.location.href='${ctx}/qywxCustomerPidRecord/approvalRoomManager?dbid=${customer.dbid }'">
...
<div class="oneMenu">
	<ul>
         <li>
             <a href="${ctx}/qywxCustomerPidRecord/roomManagerList">
             	待我审批
             </a>
