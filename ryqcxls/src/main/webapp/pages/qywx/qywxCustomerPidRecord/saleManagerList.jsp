...
<c:if test="${status==false }">
	<c:forEach items="${customers }" var="customer">
		...
		<div class="orderContrac" onclick="window.location.href='${ctx}/qywxCustomerPidRecord/approvalSaleManager?dbid=${customer.dbid }'">
...
<div class="oneMenu">
	<ul>
         <li>
             <a href="${ctx}/qywxCustomerPidRecord/saleManagerList">
             	待我审批
             </a>
