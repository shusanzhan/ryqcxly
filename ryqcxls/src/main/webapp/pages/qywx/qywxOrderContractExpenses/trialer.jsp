	...
	<form  method="post" action="" 	name="frmId" id="frmId">
		...
		<c:if test="${!empty(orderContractExpenses) }">
			...
			<c:if test="${!empty(orderContractExpenses) }">
				<div class="form-group">
					<label class="control-label" for="name">经销商报价：</label>
						<input readonly="readonly" type="text" class="form-control" value="${orderContractExpenses.salePrice }" onkeyup="countActMoney()" id="salePrice" name="orderContractExpenses.salePrice"  />
				</div>
				<div class="form-group">
						<label class="control-label" for="name">颜色溢价：</label>
		...
		<div class="form-group">
			<label class="control-label" for="name"><span style="color: red">*</span>挂车价格：</label>
			<input  class="form-control" type="number"  name="orderContractExpenses.trailerPrice" id="trailerPrice" value="${empty(orderContractExpenses)==true?'0.0':'' }${orderContractExpenses.trailerPrice }" onkeyup="orderContranctTotalPrice();loanPaymentPer();$('#trailerSalerPrice').val(this.value)" onfocus="orderContranctTotalPrice();loanPaymentPer();" checkType="float,0,"></input>
		</div>
		<div class="form-group">
			<label class="control-label" for="name"><span style="color: red">*</span>挂车结算价：</label>
			<input  class="form-control" type="number"  name="orderContractExpenses.trailerSalerPrice" id="trailerSalerPrice" value="${empty(orderContractExpenses)==true?'0.0':'' }${orderContractExpenses.trailerSalerPrice }" onkeyup="orderContranctTotalPrice();loanPaymentPer();" onfocus="orderContranctTotalPrice();loanPaymentPer();" style="color: red;" checkType="float,0" canEmpty="Y" tip="挂车结算价" readonly="readonly"></input>
		</div>
		<div class="form-group">
			<label class="control-label" for="name"><span style="color: red">*</span>裸车现金优惠：</label>
			...
			说明：不包含大客户、自有车等特殊权限优惠
		</div>
		<div class="form-group">
				<label class="control-label" for="name">特殊权限优惠：</label>
				<c:if test="${empty(orderContractExpenses) }">
					<input  class="form-control" name="orderContractExpenses.specialPermPrice" id="specialPermPrice" value="0.0" checkType="float,0," onkeyup="orderContranctTotalPrice();" onfocus="orderContranctTotalPrice();loanPaymentPer();" ></input>
				</c:if>
				<c:if test="${!empty(orderContractExpenses) }">
		...
		<div class="form-group">
				...
				<input  class="form-control" type="number"  name="orderContractExpenses.masterDecoreMoney"  id="masterDecoreMoney" value="${empty(orderContractExpenses)==true?'0.0':'' }${orderContractExpenses.masterDecoreMoney }" onkeyup="decoreTotal();orderContranctTotalPrice();loanPaymentPer();" onfocus="orderContranctTotalPrice();loanPaymentPer();" checkType="float,0,"></input>
		...
		<div class="form-group">
				<label class="control-label" for="name">D：</label>
				<input type="text" name="orderContractExpenses.lowInvoicePrice" id="lowInvoicePrice" value="${empty(orderContractExpenses)==true?'0.0':'' }${orderContractExpenses.lowInvoicePrice }"  onkeyup="orderContranctTotalPrice();loanPaymentPer();" onfocus="orderContranctTotalPrice();loanPaymentPer();"  class="form-control" style="color: red;" checkType="float,0" style="color: red;" tip="请输入购车定金,大于或等0"></input>
		</div>
		<c:if test="${empty(orderContractExpenses) }">
			<div class="form-group">
			...
			<div class="form-group">
					...
					<div>
						...
						<label ><input type="radio" value="2" name="orderContractExpenses.buyCarType" id="buyCarType"  onclick="showOrHideBuyCarWay(this.value)">分付加挂车</label>
						<label ><input type="radio" value="3" name="orderContractExpenses.buyCarType" id="buyCarType" ${orderContractExpenses.buyCarType==3?'checked="checked"':'' } onclick="showOrHideBuyCarWay(this.value)">分付裸车</label>
		...
		<c:if test="${!empty(orderContractExpenses) }">
			...
			<div class="form-group">
					...
					<div>
						...
						<label ><input type="radio" value="2" name="orderContractExpenses.buyCarType" id="buyCarType" ${orderContractExpenses.buyCarType==2?'checked="checked"':'' } onclick="showOrHideBuyCarWay(this.value)">分付加挂车</label>
						<label ><input type="radio" value="3" name="orderContractExpenses.buyCarType" id="buyCarType" ${orderContractExpenses.buyCarType==3?'checked="checked"':'' } onclick="showOrHideBuyCarWay(this.value)">分付裸车</label>
						<label style="clear: both;"></label>
					</div>
			</div>
		...
		<c:if test="${orderContractExpenses.buyCarType>=2 }">
			<div id="ajsxfDiv">
				<div class="form-group">
						<label class="control-label" for="name">按揭手续费：</label>
						<input  class="form-control" type="number" id="ajsxf" name="orderContractExpenses.ajsxf" class="largeX text" value="${orderContractExpenses.ajsxf }" onkeyup="orderContranctTotalPrice();loanPaymentPer();" onfocus="orderContranctTotalPrice();loanPaymentPer();" ></input>
				</div>
				<div class="form-group">
					<label class="control-label" for="name">首付比例：</label>
					<input type="text"   id="paymentPer" name="orderContractExpenses.paymentPer" class="form-control" value="${empty(orderContractExpenses)==true?'0.0':'' }${orderContractExpenses.paymentPer }" onkeyup="orderContranctTotalPrice();loanPaymentPer();" onfocus="orderContranctTotalPrice();loanPaymentPer();" checkType="float,0,10" canEmpty="Y" style="color: red;" tip="请输入首付比例"></input>
		...
		<div class="form-group">
			<label class="control-label" for="name">垫付状态：</label>
			<div>
				<c:if test="${empty(orderContractExpenses) }">
					<label><input type="radio" value="1" name="orderContractExpenses.loanPaymentType" id="loanPaymentType"   checked="checked" onclick="showOrHideloanPaymentType(this.value)">正常	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
					<label><input type="radio" value="2" name="orderContractExpenses.loanPaymentType" id="loanPaymentType" ${orderContractExpenses.loanPaymentType==2?'checked="checked"':'' } onclick="showOrHideloanPaymentType(this.value)">垫款</label>
				</c:if>
				<c:if test="${!empty(orderContractExpenses) }">
					<label ><input type="radio" value="1" name="orderContractExpenses.loanPaymentType" id="loanPaymentType"   ${orderContractExpenses.loanPaymentType==1?'checked="checked"':'' } onclick="showOrHideloanPaymentType(this.value)">正常	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
					<label ><input type="radio" value="2" name="orderContractExpenses.loanPaymentType" id="loanPaymentType" ${orderContractExpenses.loanPaymentType==2?'checked="checked"':'' } onclick="showOrHideloanPaymentType(this.value)">垫款</label>
				</c:if>
			</div>
		</div>
		<div id="loanPaymentTr1" style="display: ${fn:contains(orderContractExpenses.loanPaymentType,2)==true?'':'none'}" >
			<div class="form-group">
				<label class="control-label" for="name">垫付金额：</label>
				<input type="text" class="form-control"  id="loanPaymentPrice" name="orderContractExpenses.loanPaymentPrice" onkeyup="orderContranctTotalPrice();loanPaymentPer();" onfocus="orderContranctTotalPrice();loanPaymentPer();" checkType="float,0" canEmpty="Y" value="${empty(orderContractExpenses)==true?'0.0':'' }${orderContractExpenses.loanPaymentPrice }"></input>
			</div>
			<div class="form-group">
				<label class="control-label" for="name">垫付期限：</label>
				<input type="text" class="form-control"  id="loanPaymentTerm" name="orderContractExpenses.loanPaymentTerm"  checkType="string," canEmpty="Y" value="${empty(orderContractExpenses)==true?'0.0':'' }${orderContractExpenses.loanPaymentTerm }"></input>
			</div>
			<div class="form-group">
				<label class="control-label" for="name">利息：</label>
				<input type="text" class="form-control"  id="loanPaymentInterest" name="orderContractExpenses.loanPaymentInterest" checkType="float,0" canEmpty="Y" value="${empty(orderContractExpenses)==true?'0.0':'' }${orderContractExpenses.loanPaymentInterest }"></input>
			</div>
			<div class="form-group">
				<label class="control-label" for="name">垫付月还：</label>
				<input type="text" class="form-control" id="loanPaybackMonthMoney" name="orderContractExpenses.loanPaybackMonthMoney" class="largeX text enable" checkType="float,0" canEmpty="Y" value="${empty(orderContractExpenses)==true?'0.0':'' }${orderContractExpenses.loanPaybackMonthMoney }"></input>
			</div>
		</div>
		<div class="form-group">
		...
		<div id='te' style="width: 100%">
			...
			<div class="form-group">
				<label class="control-label" for="name">车辆总价：</label>
					<input readonly="readonly" type="text" class="form-control" id="carTotalPrice" name="orderContractExpenses.carTotalPrice"   value="${empty(orderContractExpenses)==true?'0.0':'' }${orderContractExpenses.carTotalPrice }"></input>
					 车辆总价=挂车价+裸车销售价
			</div>
			<div class="form-group">
				<label class="control-label" for="name">贷款车价：</label>
					...
					贷款车价（分付加挂车）：=车辆总价-低 或 贷款车价（分付裸车）：=裸车销售价-低;
			</div>	
			<div class="form-group">
...
function orderContranctTotalPrice(){
	...
	//经销商报价
	   ...
	   //实收金额=合同总金额-定金-贷款总额-垫款总额
	   actureCollectedPrice=totalPrice-orderMoney-daikuan-loanPaymentPrice;
...
function loanCarPriceFun(){
    ...
    if(buyCarType>1){
    	  ...
    	  var carTotalPrice=$("#carTotalPrice").val();
	  	   if(null!=carTotalPrice&&carTotalPrice!=''){
	  		 carTotalPrice=parseFloat(carTotalPrice);
	  		   if(isNaN(carTotalPrice)){
	  			 carTotalPrice=0; 
	  		   }
	  	   }else{
	  		 carTotalPrice=0;
	  	   }
    	  var lowInvoicePrice=$("#lowInvoicePrice").val();
	  	   if(null!=lowInvoicePrice&&lowInvoicePrice!=''){
	  		 lowInvoicePrice=parseFloat(lowInvoicePrice);
	  		   if(isNaN(lowInvoicePrice)){
	  			 lowInvoicePrice=0; 
	  		   }
	  	   }else{
	  		 lowInvoicePrice=0;
	  	 ...
	  	 //加挂贷款
    	if(buyCarType==2){
    		loanCarPrice=carTotalPrice-lowInvoicePrice;
    	}
	  	 //裸车贷款
    	if(buyCarType==3){
    		loanCarPrice=carActurePrice-lowInvoicePrice;
    	}
    }else{
    	loanCarPrice=0;
    }
...
function showOrHideloanPaymentType(value){
	if(value==2){
		$("#loanPaymentTr1").show();
	}
	if(value==1){
		$("#loanPaymentTr1").hide();
		$("#loanPaymentPrice").val("0.0");
		$("#loanPaymentTerm").val("0.0");
		$("#loanPaymentInterest").val("0.0");
		$("#loanPaybackMonthMoney").val("0.0");
		preferenceItemPrice();
	}
	orderContranctTotalPrice();loanPaymentPer();
}
