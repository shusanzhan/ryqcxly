...
<div id="hearder_nav" class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">网销线索（月）统计</span>
...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           <li class="detail_tap pull_left select" id="imgs_tap" onclick="window.location.href='${ctx}/qywxStatCustomerRecordNet/queryNetStaMonth'">月统计</li>
           <li class="detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxStatCustomerRecordNet/queryNetStaYear'">年统计</li>
      	</ul>
     </div>
 </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxStatCustomerRecordNet/queryNetStaMonth" name="searchPageForm" id="searchPageForm" method="post">
      	 <table>
