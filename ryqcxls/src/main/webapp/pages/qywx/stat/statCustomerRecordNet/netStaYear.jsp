...
<div id="hearder_nav" class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">网销线索（年）统计</span>
...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           <li class="detail_tap pull_left " id="imgs_tap" onclick="window.location.href='${ctx}/qywxStatCustomerRecordNet/queryNetStaMonth'">月统计</li>
           <li class="detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxStatCustomerRecordNet/queryNetStaYear'">年统计</li>
      	</ul>
     </div>
 </div>
...
<div class="row-fluid">
	<table class="table table-bordered table-striped" style="font-size: 10px;">
		...
		<tr>
			...
			<td style="width: 60px">总线索</td>
			<td style="width: 60px">有效客户</td>
			<td style="width: 60px">有效率</td>
		</tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxStatCustomerRecordNet/queryNetStaYear" name="searchPageForm" id="searchPageForm" method="post">
      	 <table>
...
function ajaxCarCount(){
	...
	$.post("${ctx}/qywxStatCustomerRecordNet/ajaxCarCount?customerInfromSetDbid="+customerInfromSetDbid+"&dateType=1",params,function(data){
		if(data=="error"){
			alert("查询出错！");
		}else{
			var obj=data.split("|");
