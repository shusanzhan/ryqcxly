...
<div id="hearder_nav" class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">客户回访（月）统计</span>
...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           <li class="detail_tap pull_left select" id="imgs_tap" onclick="window.location.href='${ctx}/qywxTrack/queryTrackList'">月统计</li>
           <li class="detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxTrack/queryTrackYearList'">年统计</li>
      	</ul>
     </div>
 </div>
		...
		<tbody>
			...
			<c:forEach items="${tracks }" var="track" varStatus="i">
				<tr>
					...
					<td>
						<fmt:formatDate value="${track.createDate}" pattern="yyyy-MM-dd"/> 
					</td>
					<td>
						${track.waitNum }
					</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxTrack/queryTrackList" name="searchPageForm" id="searchPageForm" method="post">
      	 <table>
