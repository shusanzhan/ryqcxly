...
<div class="mycenterMian" style="">
	  	 <article>
				...
				<ul>
					<li>
				        <a href="${ctx }/qywxStatic/customerStatic">
				           <img src="${ctx }/images/weixin/kfgc.jpg">
				           <p>客户构成</p>
				       </a>
				   </li>
					<li>
				        <a href="${ctx }/qywxStatic/customerLevel">
				           <img src="${ctx }/images/weixin/level.jpg">
				           <p>客户等级分析</p>
				       </a>
				   </li>
					<li>
				        <a href="${ctx }/qywxStatic/successCustomerCar">
				           <img src="${ctx }/images/weixin/cjkh.jpg">
				           <p>成交客户</p>
				       </a>
				   </li>
					<li>
				        <a href="${ctx }/qywxStatic/waitingCustomerCar">
				           <img src="${ctx }/images/weixin/djc.jpg">
				           <p>待交车</p>
				       </a>
				   </li>
				    <li>
				        <a href="${ctx }/qywxStatic/visitRecord">
