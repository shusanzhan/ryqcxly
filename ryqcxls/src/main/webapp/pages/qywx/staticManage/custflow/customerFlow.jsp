     ...
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
         	<c:if test="${param.type==1 }" var="status">
	           <li class="detail_tap5 detail_tap pull_left select" id="imgs_tap" onclick="window.location.href='${ctx}/qywxFlowReport/customerFlow?type=1&role=${param.role}'">日</li>
         	</c:if>
         	<c:if test="${status==false }">
	           <li class="detail_tap5 detail_tap pull_left" id="imgs_tap" onclick="window.location.href='${ctx}/qywxFlowReport/customerFlow?type=1&role=${param.role}'">日</li>
         	</c:if>
         	<c:if test="${param.type==2 }" var="status">
	           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFlowReport/customerFlow?type=2&role=${param.role}'">周报</li>
         	</c:if>
         	<c:if test="${status==false }">
	           <li class="detail_tap5 detail_tap pull_left" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFlowReport/customerFlow?type=2&role=${param.role}'">周报</li>
         	</c:if>
         	<c:if test="${param.type==3 }" var="status">
	            <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFlowReport/customerFlow?type=3&role=${param.role}'">月报</li>
         	</c:if>
         	<c:if test="${status==false }">
	            <li class="detail_tap5 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFlowReport/customerFlow?type=3&role=${param.role}'">月报</li>
         	</c:if>
         	<c:if test="${param.type==4 }" var="status">
	           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFlowReport/customerFlow?type=4&role=${param.role}'">季报</li>
         	</c:if>
         	<c:if test="${status==false }">
	           <li class="detail_tap5 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFlowReport/customerFlow?type=4&role=${param.role}'">季报</li>
         	</c:if>
         	<c:if test="${param.type==5 }" var="status">
	           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFlowReport/customerFlow?type=5&role=${param.role}'">年报</li>
         	</c:if>
         	<c:if test="${status==false }">
	           <li class="detail_tap5 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFlowReport/customerFlow?type=5&role=${param.role}'">年报</li>
         	</c:if>
	...
	<table class="table table-bordered table-striped">
		<tbody>
			<tr>
				...
				<td align="center" width="40">流失原因</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxFlowReport/customerFlow" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr>
...
function ajaxEnterprise(val){
	$.ajax({	
		url : '/qywxCustSuccess/ajaxEnterpriseYear?type=${param.type}&role=${param.role}&enterPriseId='+val, 
		data : {}, 
		async : false, 
		timeout : 20000, 
		dataType : "json",
