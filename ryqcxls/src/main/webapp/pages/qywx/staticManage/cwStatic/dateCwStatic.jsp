...
<div id="hearder_nav" class="views content_title navbar-fixed-top" >
    ...
    <span id="page_title">财务日统计一览表</span>
...
<div class="listOperate" >
   <div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx }/qywxCwProfitStatical/queryDateCwStatic" method="post" >
...
<table width="1024" border="1" class="mainTable" cellpadding="0" cellspacing="0" style="border: 1px solid #fff;width: 1024px;">
		<tr>
