...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           <li class="detail_tap4 detail_tap pull_left select" id="imgs_tap" onclick="window.location.href='${ctx}/qywxFjDep/day'">日</li>
           ...
           <li class="detail_tap4 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFjDep/year'">年</li>
      	</ul>
     </div>
 </div>
<div class="row-fluid" style="text-align: center;border-bottom: 1px solid #ed145b;margin-bottom: 12px;color:#ed145b;">
	<h5 style="text-align: left;font-size: 16px">
		自有店（<fmt:formatDate value="${startTime }" pattern="MM月dd日"/>）
	</h5>
</div>
<div class="row-fluid">
	...
	<table class="table table-bordered table-striped">
		<tbody>
			<tr>
				...
				<td align="center" width="60">单位</td>
				<td align="center" width="50">成交量</td>
				<td align="center" width="40">按揭量</td>
				<td align="center" width="40">渗透率</td>
...
<div class="row-fluid" style="text-align: center;border-bottom: 1px solid #ed145b;margin-bottom: 12px;color:#ed145b;">
	<h5 style="text-align: left;font-size: 16px">
		二网附加 （<fmt:formatDate value="${startTime }" pattern="MM月dd日"/>）
	</h5>
</div>
<div class="row-fluid">
	<table class="table table-bordered table-striped">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxFjDep/day" name="frmId" id="frmId" method="post">
      	 <table>
      	 		<tr>
