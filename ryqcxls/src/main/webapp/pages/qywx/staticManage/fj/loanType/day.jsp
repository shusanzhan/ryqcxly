...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           <li class="detail_tap4 detail_tap pull_left select" id="imgs_tap" onclick="window.location.href='${ctx}/qywxHfLoanType/day'">日</li>
           <li class="detail_tap4 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxHfLoanType/week'">周</li>
           <li class="detail_tap4 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxHfLoanType/month'">月</li>
...
<div class="row-fluid" style="text-align: center;border-bottom: 1px solid #ed145b;margin-bottom: 12px;color:#ed145b;">
	<h5 style="text-align: left;font-size: 16px">
		自有店贷款方式 <fmt:formatDate value="${startTime }" pattern="MM月dd日"/> 
...
<div class="row-fluid" style="text-align: center;border-bottom: 1px solid #ed145b;margin-bottom: 12px;color:#ed145b;">
	<h5 style="text-align: left;font-size: 16px">
		二网贷款方式 <fmt:formatDate value="${startTime }" pattern="MM月dd日"/> 
		<span style="font-size: 14px;">总数：${totalNum },自有店：${selfTotalNum },二网：${netTotalNum }</span>
	</h5>
</div>
<div class="row-fluid">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxHfLoanType/day" name="frmId" id="frmId" method="post">
      	 <table>
      	 		<tr>
