...
<div id="hearder_nav" class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">附加销售顾问月报表</span>
...
<div id="detail_nav">
     <div class="detail_nav_inner">
          <ul class="clearfix padding10">
           ...
           <li class="detail_tap4 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFjSale/week'">周</li>
           <li class="detail_tap4 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxFjSale/month'">月</li>
...
<div class="row-fluid">
	<%-- <h5 style="text-align: left;font-size: 16px;color:#ed145b;">
		<span style="font-size: 14px;">1、附加总金额</span>
	</h5>
	<table class="table table-bordered table-striped">
		<tbody>
			<tr>
				...
				<td align="center" width="40">附加</td>
				<td align="center" width="40">平均</td>
			</tr>
			<c:if test="${empty(fjzjeSalers)||fn:length(fjzjeSalers)<=0 }" var="status">
				<tr>
					<td colspan="5">无数据</td>
				</tr>
			</c:if>
			<c:if test="${status==false }">
				<c:forEach var="fjzjeSaler" items="${fjzjeSalers }" varStatus="i">
					<tr>
						<td  align="center" width="20">${i.index+1 }</td>
						<td align="center" width="80">${fjzjeSaler.realName }</td>
						<td align="center" width="60">${fjzjeSaler.successNum }</td>
						<td align="center" width="40">
							<c:if test="${empty(fjzjeSaler.fjzje) }">
								0
							</c:if>
							<c:if test="${!empty(fjzjeSaler.fjzje) }">
								${fjzjeSaler.fjzje }
						...
						<td align="center" width="40">
							<fmt:formatNumber value="${fjzjeSaler.avg }" pattern="0.##"></fmt:formatNumber>
						</td>
					</tr>
				</c:forEach>
			</c:if>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxFjSale/month" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr>
