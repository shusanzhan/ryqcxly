...
<div id="detail_nav">
     <div class="detail_nav_inner">
          <ul class="clearfix padding10">
           <li class="detail_tap2 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxHfQuest/month?brandId=${brandId}'">月</li>
           <li class="detail_tap2 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxHfQuest/year?brandId=${brandId}'">年</li>
      	</ul>
     </div>
 </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxHfQuest/month" name="frmId" id="frmId" method="post">
