...
<div id="hearder_nav" class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">车辆库龄分析（成交客户）</span>
		...
		<tbody>
			<tr>
				<c:forEach var="carSerCount" items="${carSerCounts }" >
					<td align="center">${carSerCount.serName }</td>
				</c:forEach>
			</tr>
			<tr>
				<c:forEach var="carSerCount" items="${carSerCounts }" >
					<td align="center">${carSerCount.countNum }</td>
				</c:forEach>
			</tr>
		</tbody>
	</table>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxStatic/successCustomerCar" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr>
