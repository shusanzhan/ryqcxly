...
<title>${storeArea.name }区域库存区域统计</title>
</head>
<body>
<div class="views content_title navbar-fixed-top">
    ...
    <span id="page_title">${storeArea.name }区域库存区域统计</span>
...
<c:if test="${fn:length(carSerCounts)>0 }" var="status">
	...
	<c:forEach var="carSerCount" items="${carSerCounts }">
	 <li class="list-group-item" onclick="window.location.href='${ctx}/qywxWlReport/carSeriyFactoryOrder?carserId=${carSerCount.serid }&enterpriseId=${param.enterpriseId }'">
