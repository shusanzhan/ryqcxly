...
<div id="detail_nav">
     <div class="detail_nav_inner">
	  <ul class="clearfix padding10">
	        ...
	        <li class="detail_tap4 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxRoomManageFlowReport/customerFlowMonth'">月</li>
...
<div class="row-fluid">
		<h5 style="text-align: left;font-size: 16px">
			...
			当月流失客户<span style="color: #ed145b;font-size: 18px;">${todayTotalNum }</span>人.
		</h5>
		<div class="span6">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxRoomManageFlowReport/customerFlowMonth" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr>
