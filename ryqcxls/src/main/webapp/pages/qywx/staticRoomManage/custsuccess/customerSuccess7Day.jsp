...
<div id="detail_nav">
     <div class="detail_nav_inner">
           ...
           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxRoomManageSuccessReport/customerSuccess7Day'">最近7日</li>
...
<div class="row-fluid" style="text-align: center;border-bottom: 1px solid #ed145b;margin-bottom: 12px;color:#ed145b;">
	<h5 style="text-align: left;font-size: 16px">
		最近7日总成交客户<span style="font-size: 14px;">(总数：${totalWeekNum },前6日平均：${avageCustomer }人,今日：${newsCount }人)</span>
	</h5>
</div>
<div class="row-fluid">
		<div class="span6">
