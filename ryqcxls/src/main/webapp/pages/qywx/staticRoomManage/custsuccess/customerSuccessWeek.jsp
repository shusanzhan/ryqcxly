...
<div id="detail_nav">
     <div class="detail_nav_inner">
          <ul class="clearfix padding10">
           ...
           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxRoomManageSuccessReport/customerSuccessWeek'">周</li>
...
<div class="row-fluid" style="text-align: center;border-bottom: 1px solid #ed145b;margin-bottom: 12px;color:#ed145b;">
	<h5 style="text-align: left;font-size: 16px">
		最近7周总成交客户量<span style="font-size: 14px;">(总数：${totalWeekNum },平均：${avageCustomer }人,本周：${newsCount }人)</span>
	</h5>
</div>
<div class="row-fluid">
		<div class="span6">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxRoomManageSuccessReport/todayStatic" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr>
...
Highcharts.setOptions({  
    lang: {  
          ...
          shortMonths: ['1月', '2月', '3月', '4月', '5月', '6月',  
           ...
           weekdays: ['最近7周日', '最近7周二','Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi']  
    }  
});  
$(function () {
