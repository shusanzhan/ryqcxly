...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           ...
           <li class="detail_tap3 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxOrder/queryOrderList'">当月订单</li>
...
<div class="row-fluid">
	<h5 style="text-align: left;font-size: 16px">
		<fmt:formatDate value="${start }" pattern="yyyy-MM"/> 月日订单明细
	</h5>
	<table class="table table-bordered table-striped">
		<tbody>
			<tr>
				...
				<td style="width: 60px">自有店</td>
				<td style="width: 60px">二网</td>
...
<div class="row-fluid">
	...
	<table class="table table-bordered table-striped">
		<tbody>
			<tr>
				<td style="width: 50px;">序号</td>
				<td style="width: 120px">线索类型</td>
				<td style="width: 60px">订单量</td>
			</tr>
...
<div class="row-fluid">
	...
	<table class="table table-bordered table-striped">
		<tbody>
			...
			<c:forEach var="carSerCountTotal" items="${orderCarSeriyAll }" varStatus="i">
				<tr>
					<td>${i.index+1}</td>
