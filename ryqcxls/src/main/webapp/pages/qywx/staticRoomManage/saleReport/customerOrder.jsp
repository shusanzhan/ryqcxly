...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           <li class="detail_tap3 detail_tap pull_left select" id="imgs_tap" onclick="window.location.href='${ctx}/qywxRoomManageSaleReport/customerOrder'">当日新增订单</li>
           <li class="detail_tap3 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qqywxOrder/queryOrderList'">当月订单</li>
           <li class="detail_tap3 detail_tap pull_left " id="pingjia_tap" onclick="window.location.href='${ctx}/qywxRoomManageSaleReport/waitingCustomerCar'">留存订单</li>
      	</ul>
     </div>
 </div>
...
<div class="row-fluid">
	<h5 style="text-align: left;font-size: 16px">
		总订单<span style="color: #ed145b;font-size: 18px;">${selfShopTotal+netTotal }</span>台，
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxRoomManageSaleReport/customerOrder" name="frmId" id="frmId" method="post">
      	 <table>
      	 		<tr>
