...
<div id="detail_nav">
     <div class="detail_nav_inner">
         <ul class="clearfix padding10">
           ...
           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxRoomManageSaleReport/customerWeek'">周</li>
...
<div class="row-fluid" style="text-align: center;border-bottom: 1px solid #ed145b;margin-bottom: 12px;color:#ed145b;">
	<h5 style="text-align: left;font-size: 16px">
		<c:if test="${paramWeek>=2  }">
			集客量<span style="font-size: 14px;">(总数：${totalWeekNum },前6周平均：${avageCustomer }人,本周：${newsCount }人)</span>
		</c:if>
		<c:if test="${paramWeek<=2  }">
			集客量<span style="font-size: 14px;">(总数：${totalWeekNum },本周：${newsCount }人)</span>
		</c:if>
	</h5>
</div>
<div class="row-fluid">
