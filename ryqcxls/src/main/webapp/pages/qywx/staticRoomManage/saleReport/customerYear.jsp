...
<div id="detail_nav">
     <div class="detail_nav_inner">
          <ul class="clearfix padding10">
           <li class="detail_tap5 detail_tap pull_left " id="imgs_tap" onclick="window.location.href='${ctx}/qywxRoomManageSaleReport/todayStatic'">日</li>
           ...
           <li class="detail_tap5 detail_tap pull_left select" id="pingjia_tap" onclick="window.location.href='${ctx}/qywxRoomManageSaleReport/customerYear'">年</li>
      	</ul>
     </div>
 </div>
	...
	<h5 style="text-align: left;font-size: 16px">
		<c:if test="${monthNum>1 }">
			<c:if test="${fn:contains(nowMonthDay,monthDay)}" var="status">
				${monthDay }年总集客量<span style="font-size: 14px;">(总数：${totalWeekNum },前${monthNum-1 }平均：${avageCustomer }人,当月：${newsCount }人)</span>
			</c:if>
			<c:if test="${status==false }">
				${monthDay }年总集客量<span style="font-size: 14px;">(总数：${totalWeekNum },平均每月：${avageCustomer }人)</span>
			</c:if>
		</c:if>
		<c:if test="${monthNum<=1 }">
			${monthDay }年总集客量<span style="font-size: 14px;">(总数：${totalWeekNum },当月：${newsCount }人)</span>
		</c:if>
	</h5>
</div>
<div class="row-fluid">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-inline" action="${ctx }/qywxRoomManageSaleReport/customerYear" name="frmId" id="frmId" method="post">
      	 <table>
      	 	<tr>
