...
<div class="mycenterMian" style="">
	  	 <article>
				...
				<ul>
					<li>
				        <a href="${ctx }/qywxRoomManageSaleReport/todayStatic">
				           <img src="${ctx }/images/weixin/kfgc.jpg">
				           <p>集客报表</p>
				       </a>
				   </li>
					<li>
				        <a href="${ctx }/qywxRoomManageSaleReport/customerOrder">
				           <img src="${ctx }/images/weixin/hfkf.jpg">
				           <p>订单报表</p>
				       </a>
				   </li>
				   <li>
				        <a href="${ctx }/qywxRoomManageSuccessReport/customerSuccess">
				           <img src="${ctx }/images/weixin/level.jpg">
				           <p>成交客户</p>
				       </a>
				   </li>
				   <li>
				        <a href="${ctx }/qywxRoomManageFlowReport/customerFlow">
