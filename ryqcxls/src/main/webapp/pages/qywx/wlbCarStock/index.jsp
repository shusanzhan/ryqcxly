              ...
              <div class="mycenter">
                  <ul>
                  	<c:forEach var="brand" items="${brands }">
                       <li>
                           <a href="${ctx }/qywxWlbFacotoryOrder/carSeriyList?brandId=${brand.dbid}">
                               <img src="${brand.logo }">
                               <p>${brand.name }</p>
                           </a>
                       </li>
...
<c:if test="${fn:length(carSerCounts)>0 }" var="status">
	<c:forEach var="carSerCount" items="${carSerCounts }">
	 <li class="list-group-item" onclick="window.location.href='${ctx }/qywxWlbFacotoryOrder/carSeriyList?brandId=${carSerCount.serid}'" style="cursor: pointer;">
