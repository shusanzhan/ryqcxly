		...
		<tr>
			...
			<tr height="42">
				...
				<td ><input type="text" name="carColor.name" id="name"
					value="${carColor.name }" class="largex text" title="名称"	checkType="string,1,50" tip="名称不能为空"><span style="color: red;">*</span></td>
			</tr>
			<tr height="32">
				<td class="formTableTdLeft">备注:&nbsp;</td>
				<td>
					<textarea class="text textarea" rows="8" cols="60" name="carColor.note" id="note">${carColor.note }</textarea>
				</td>
			</tr>
		</table>
	</form>
	<div class="formButton">
		<a href="javascript:void(-1)"	onclick="$.utile.submitForm('frmId','${ctx}/carColor/save')"	class="but butSave">保&nbsp;&nbsp;存</a> 
