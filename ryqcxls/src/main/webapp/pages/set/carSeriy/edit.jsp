...
<div class="frmContent">
	<form class="form-horizontal" method="post" action="" 	name="frmId" id="frmId">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
				...
				<tr>
					<td class="formTableTdLeft">是否有试驾车：</td>
					<td colspan="">
						<select id="tryCarStatus" class="large text" name="carSeriy.tryCarStatus">
							<option value="">请选择...</option>
							<option value="1" ${carSeriy.tryCarStatus==1?'selected="selected"':'' } >有</option>
							<option value="2" ${carSeriy.tryCarStatus==2?'selected="selected"':'' } >无</option>
						</select>
					</td>
					<td class="formTableTdLeft">综合优惠：</td>
					<td>
						<input type="text" class="largeX text" name="carSeriy.discInfor"	id="discInfor" value="${carSeriy.discInfor}" checkType="string,1,2000"  tip="请输入综合优惠！"  />
					</td>
				</tr>
				<tr>
