...
<div class="listOperate">
	<div class="operate">
		<a href="javascript:void(-1)"  onclick="window.location.href='${ctx}/twoComeShop/queryComeShopList'" style="color: #2b7dbc;">到店客户月统计</a>
  	...
  	<div class="seracrhOperate" style="margin: 20px 1px;">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/comeShop/queryComeShopYearList" method="post" >
		...
		<table class="staltalbe" style="width: 100%;" cellpadding="0" cellspacing="0">
			...
			<c:forEach items="${comeShops }" var="comeShop" varStatus="i">
				<tr>
					...
					<td>
						<fmt:formatDate value="${comeShop.createDate}" pattern="yyyy-MM"/> 
					</td>
					<td>
...
<h3>当月销售顾问创建潜客到店率统计</h3>
<p style="color: red;"><span style="color: red;font-weight: bold;">说明：销售顾问字段是使用【邀约销售顾问ID】作为基数</span></p>
<table class="staltalbe" style="width: 100%;" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				<td style="width: 40px;">序号</td>
...
<br>
<h3>潜客（总）销售顾问邀约店率统计（含历史数据)</h3>
<p style="color: red;"><span>说明：该统计反应客户邀约情况，不能反应接待客户谈判情况</span></p>
<table class="staltalbe" style="width: 100%;" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				<td style="width: 40px;">序号</td>
...
<br>
<h3>到店客户转订单率统计</h3>
<p style="color: red;"><span>说明：到店客户和到店总客户都含有网销邀约到店数据</span></p>
<p style="color: red;"><span>说明：无法明确，网销销售顾问-真实邀约客户批次</span></p>
<p style="color: red;"><span>说明：无法明确，展厅谈判销售顾问-真实谈判网销邀约客户批次</span></p>
<table class="staltalbe" style="width: 100%;" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				<td style="width: 40px;">序号</td>
...
$(function () {
	...
	$('#comeShopPieCarSerData').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }到店总客户销售顾问占比'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
	...
	$('#comeShopPieUserData').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }到店客户转订单车型占比'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
