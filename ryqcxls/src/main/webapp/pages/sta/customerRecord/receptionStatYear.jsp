...
<div class="listOperate">
	<div class="operate" style="color: #000;">
		<a href="javascript:void(-1)"  onclick="window.location.href='${ctx}/statCustomerRecord/queryReceptionStat'" style="color: #2b7dbc;">展厅流量月统计</a>
		|
  	...
  	<div class="seracrhOperate" style="margin: 20px 1px;">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/statCustomerRecord/queryReceptionStatYear" method="post" >
...
<div class="hightChat">
	...
	<div id="carLine" style="width: 100%;"></div>
</div>
<br>
<br>
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
...
<table class="staltalbe" style="width: 100%;" cellpadding="0" cellspacing="0">
	...
	<c:forEach items="${staCustomerRecordMonths }" var="staCustomerRecordMonth" varStatus="i">
		<tr>
			<td>
				${i.index+1 }
			</td>
			<td>
				<fmt:formatDate value="${staCustomerRecordMonth.createDate}" pattern="yyyy-MM"/> 
			</td>
			...
			<td>${staCustomerRecordMonth.comeShopCreateFolderNumPer}</td>	
			...
			<td>${staCustomerRecordMonth.phoneCreateFolderPer}</td>	
		</tr>
	</c:forEach>
	<tr style="font-weight: bold;">
		<td colspan="2">
...
$(function () {
  ...
  $('#container5').highcharts({
	  chart: {
		...
		series: [${receptionPhoneMonthData}]
	});
  /* $('#carLine').highcharts({
		chart: {
			type: 'line'
