...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="">流失客户统计</a>-
...
<div class="listOperate">
	<div class="operate">
		<a href="javascript:void(-1)"  onclick="window.location.href='${ctx}/flow/queryFlowYearList'" style="color: #2b7dbc;">流失客户客户年统计</a>
  	...
  	<div class="seracrhOperate" style="margin: 20px 1px;">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/flow/queryFlowList" method="post" >
