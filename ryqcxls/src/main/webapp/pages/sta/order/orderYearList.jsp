...
<div class="listOperate">
	<div class="operate">
		<a href="javascript:void(-1)"  onclick="window.location.href='${ctx}/order/queryOrderList'" style="color: #2b7dbc;">到店客户月统计</a>
  	...
  	<div class="seracrhOperate" style="margin: 20px 1px;">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/order/queryOrderYearList" method="post" >
