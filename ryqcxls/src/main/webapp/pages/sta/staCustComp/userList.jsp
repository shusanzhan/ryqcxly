...
function querySaler(searchFrm,compId){
	var params;
	if(null!=searchFrm&&searchFrm!=undefined&&searchFrm!=''){
		params=$("#"+searchFrm).serialize();
	}
	window.location.href='${ctx }/tryCarFactStatic/querySaler?compId='+compId+'&'+params;
}
$(function () {
