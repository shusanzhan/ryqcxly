...
<div class="listOperate">
	<div class="operate">
		<a href="javascript:void(-1)"  onclick="window.location.href='${ctx}/staTryCar/queryTryCarList'" style="color: #2b7dbc;">试乘试驾月统计</a>
  	...
  	<div class="seracrhOperate" style="margin: 20px 1px;">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/staTryCar/queryTryCarYearList" method="post" >
