...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="">网销邀约率统计</a>-
...
<div class="listOperate">
	<div class="operate">
		<a href="javascript:void(-1)"  onclick="window.location.href='${ctx}/statCustomerInvitation/queryInvitationYearList'" style="color: #2b7dbc;">网销潜客月统计</a> <span style="color:#3eb94e ">|</span>
   </div>
  	<div class="seracrhOperate" style="margin: 20px 1px;">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/statCustomerInvitation/queryInvitationYearList" method="post" >
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>网销潜客/邀约到店统计</legend>
</fieldset>
<ul class="nav nav-tabs" role="tablist">
  <li class="active">
  	<a href="#baseInfo" role="tab" data-toggle="tab">网销潜客统计</a>
  </li>
  <li>
  	<a href="#baseInfo2" role="tab" data-toggle="tab">网销邀约到店统计</a>
  </li>
</ul>
		...
		<table class="staltalbe" style="width: 100%;" cellpadding="0" cellspacing="0">
			...
			<c:forEach items="${mapCustomerInfromStaSets }" var="map" varStatus="i">
				...
				<tr>
					...
					<td>
						<fmt:formatDate value="${staCustomerRecordDateNum.createDate}" pattern="yyyy-MM"/> 
					</td>
...
<br>
<div class="hightChat">
	<div id="pieCustomerInfromStaSet" style="width: 49%;float: left"></div>
	<div id="pieCustomerInfromComeShopStaSet" style="width: 49%;float: left"></div>
	<div style="clear: both;"></div>
</div>
<br>
<h3>总潜客邀约到店率</h3>
...
<br>
<div class="hightChat">
	<div id="pieCustomerInfromStaSetAll" style="width: 49%;float: left"></div>
	<div id="pieCustomerInfromComeShopStaSetAll" style="width: 49%;float: left"></div>
	<div style="clear: both;"></div>
</div>
<br>
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
...
<table class="staltalbe" style="width: 100%;" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td colspan="2">合计</td>
			...
			<td>
					<c:if test="${!empty(customerRecordUserTotal.creatorFolderPer)}" var="status">
...
<br>
<div class="hightChat">
	<div id="pieUserMonthAll" style="width: 49%;float: left;"></div>
	<div id="pieUserMonthAllComeShop" style="width: 49%;float: left;"></div>
	<div style="clear: both;"></div>
</div>
<br>
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>网销潜客邀约同比/环比统计</legend>
</fieldset>
<h3>当年潜客数据同比环比</h3>
<table class="staltalbe" style="width: 100%;" cellpadding="0" cellspacing="0">
	<thead>
...
$(function () {
	...
	$('#pieCustomerInfromStaSet').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }当年潜客各网销平台占比'
		},
		tooltip: {
	...
	$('#pieCustomerInfromComeShopStaSet').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }当年潜客各网销平台邀约占比'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
	...
	$('#pieCustomerInfromStaSetAll').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }总潜客各网销平台占比'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
	...
	$('#pieCustomerInfromComeShopStaSetAll').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }总潜客各网销邀约占比'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
	...
	$('#pieUserMonth').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }当年潜客各销售顾问占比'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
	...
	$('#pieUserMonthComeShop').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }当年潜客各销售顾问邀约占比'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
	...
	$('#pieUserMonthAll').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }总潜客各销售顾问占比'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
	...
	$('#pieUserMonthAllComeShop').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }总潜客各销售顾问邀约占比'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
...
function ajaxCarCount(){
	...
	$.post("${ctx}/statCustomerInvitation/ajaxCarCount?customerInfromSetDbid="+customerInfromSetDbid+"&dateType=2",params,function(data){
		if(data=="error"){
			alert("查询出错！");
		}else{
			var obj=data.split("|");
...
function chart3(data){
	...
	chartB=new Highcharts.Chart({
		...
		title: {
			text: '${beginDate }至${endDate }网销邀约到店关注车型'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
