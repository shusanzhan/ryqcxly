...
<div class="listOperate">
	<div class="operate">
		<a href="javascript:void(-1)"  onclick="window.location.href='${ctx}/statCustomerRecordNet/queryNetStaMonth'" style="color: #2b7dbc;">网销线索月统计</a>
  	...
  	<div class="seracrhOperate" style="margin: 20px 1px;">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/statCustomerRecordNet/queryNetStaYear" method="post" >
...
<br>
<div class="hightChat">
	<div id="customerInfromEff" style="width: 98%"></div>
	<div style="clear: both;"></div>
</div>
<br>
<div class="hightChat">
...
function ajaxCarCount(){
	...
	$.post("${ctx}/statCustomerRecordNet/ajaxCarCount?customerInfromSetDbid="+customerInfromSetDbid+"&dateType=2",params,function(data){
		if(data=="error"){
			alert("查询出错！");
		}else{
			var obj=data.split("|");
