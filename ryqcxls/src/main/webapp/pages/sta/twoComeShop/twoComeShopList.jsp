...
<div class="listOperate">
	<div class="operate">
		<a href="javascript:void(-1)"  onclick="window.location.href='${ctx}/twoComeShop/queryTwoComeShopYearList'" style="color: #2b7dbc;">二次到店客户年统计</a>
  	...
  	<div class="seracrhOperate" style="margin: 20px 1px;">
  		<form name="searchPageForm" id="searchPageForm"  action="${ctx}/twoComeShop/queryTwoComeShopList" method="post" >
...
<br>
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>销售顾问二次到店率/二次到店转订单率统计</legend>
</fieldset>
<table class="staltalbe" style="width: 100%;" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
...
$(function () {
	...
	$('#pieComeShop').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }首次到店与二次到店客户占比'
		},
		tooltip: {
	...
	$('#pieCustomerTryCar').highcharts({
		...
		title: {
			text: '${beginDate }至${endDate }二次到店客户客户各车型占比'
		},
		tooltip: {
			pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
		},
