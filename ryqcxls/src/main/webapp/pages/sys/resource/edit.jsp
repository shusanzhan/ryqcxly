	...
	<form action="" name="frmId" id="frmId" style="margin-bottom: 40px;" target="_parent">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				...
				<td>
					<select id="menu" name="resource.menu"  class="largeX text" checkType="string" tip="请选择连接类型">
			...
			<tr height="42">
				...
				<td ><input type="text" name="resource.title" id="title"
					value="${resource.title }" class="largeX text" title="用户名"	checkType="string" tip="标题不能为空"><span style="color: red;">*</span></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">url连接:&nbsp;</td>
				<td ><input type="text" name="resource.content" id="content"
					value="${resource.content }" class="largeX text" title="用户名"></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft">序号:&nbsp;</td>
				<td ><input type="text" name="resource.orderNo" id="orderNo"
					value="${resource.orderNo }" class="largeX text" checkType="integer" canEmpty="Y" tip="必须输入数字" title="用户名"></td>
			</tr>
		</table>
	</form>
	<div class="formButton">
		<a href="javascript:void(-1)"	onclick="$.utile.submitForm('frmId','${ctx}/resource/save')"	class="but butSave">保&nbsp;&nbsp;存</a> 
	</div>
	</div>
</body>
</html>