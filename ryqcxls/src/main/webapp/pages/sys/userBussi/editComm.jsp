...
<div class="frmContent">
	<form action="" name="frmId" id="frmId"  target="_self">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			...
			<tr height="32">
				...
				<td>
					<input type="hidden" name="parentId" id="parentId"	value="${user.parent.dbid }">
					<input type="text" name="parentName" id="parentName" value="${user.parent.realName }" class="large text"  title="直属领导" onfocus="autoUser('parentName')" checkType="string,1,10" tip="真实名称不能为空"><span style="color: red;">*</span>
				</td>
			</tr>
			<tr height="32">
	...
	<div class="formButton">
		<a href="javascript:void(-1)"	onclick="$('#type').val(1);$.utile.submitForm('frmId','${ctx}/userBussi/saveComm')"	class="but butSave">保&nbsp;&nbsp;存</a> 
		<a href="javascript:void(-1)"	onclick="$('#type').val(2);$.utile.submitForm('frmId','${ctx}/userBussi/saveComm')"	class="but butSave">保存分配权限</a> 
