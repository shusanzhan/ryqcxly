	...
	<table width="100%" class="mainTable" border="0" id="TableList" style="margin: 0 auto;">
		<tbody>
			...
			<c:if test="${systemInfo.grofitAprovalStatus==2 }">
				<tr height='32'>
					<td style="text-align: left;">
						<label>申请权限金额（元）：<input  type="text" id="approvalMoney" name="approvalMoney" value="${user2.approvalMoney }" class="text large"></label>,最大审批权限请设置为<span style="color: red;">-1</span>
					</td>
				</tr>
			</c:if>
		</tbody>
...
<div class="formButton">
    <a class="but butSave" href="javascript:void();" onclick="$.utile.submitForm('frmId','${ctx}/userBussi/saveUserRole')">保存</a>
 	<a href="${ctx }/userBussi/queryBussiList"	onclick="" class="but butCancle">返回</a>
</div>
</body>
</html>