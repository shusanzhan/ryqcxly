        ...
        <div class="weui_panel_bd">
        	<c:forEach var="carModel" items="${carModels }">
	            <a href="${ctx }/carModelWechat/carModel?dbid=${carModel.dbid}" class="weui_media_box weui_media_appmsg">
	                <div class="weui_media_hd" style="width: 120px;height: 60px;">
	                    <img class="weui_media_appmsg_thumb" src="${carModel.picture }" alt="" width="100%" height="60">
	                </div>
	                <div class="weui_media_bd">
	                    <h4 class="weui_media_title">${carModel.brand.name }${carModel.name }</h4>
	                    <p class="weui_media_desc">新车指导价：<span style="color: #E67816">${carModel.priceFrom }</span></p>
	                </div>
	            </a>
            </c:forEach>
        </div>
