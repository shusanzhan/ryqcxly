	...
	<div class="msg">
		<div class="weui_msg">
		    ...
		    <div class="weui_text_area">
		        <h2 class="weui_msg_title">预约操作失败</h2>
		        <p class="weui_msg_desc">若问题一直存在，请联系客服<a  href="tel:${enterprise.phone }" style="color: #888;font-size: 14px;">${enterprise.phone }</a></p>
		    </div>
		    <div class="weui_opr_area">
		        <p class="weui_btn_area">
		            <a href="javascript:;" onclick="window.history.go(-1)" class="weui_btn weui_btn_default">返回重试</a>
		        </p>
		    </div>
