...
<div class="title">
    ...
    <h3>${enterprise.name }试乘试驾在线预约</h3>
</div>
<br>
<br>
<br>
...
<form action="" id="frmId" name="frmId" method="post" target="_self">
	<input type="hidden" value="${param.wechat_id }" id="microId" name="onlineBooking.microId">
  		<input type="hidden" value="1" id="bookingType" name="onlineBooking.bookingType">
<div class="weui_cells weui_cells_form">
       <div class="weui_cell weui_cell_select weui_select_after">
           <div class="weui_cell_hd"><label class="weui_label" style="width: 75px;">车型</label></div>
           <div class="weui_cell_bd weui_cell_primary" id="areaLabel">
               <select id="carSeriy" name="carSeriy"  class="weui_select" checkType="integer,1">
       ...
       <div class="weui_cell">
           ...
           <div class="weui_cell_bd weui_cell_primary">
               <input type="text"  placeholder="请输入联系人" value="${member.name  }" name="onlineBooking.name" id="name" class="weui_input" checkType="string,1"/>
          </div>
       </div>
       <div class="weui_cell">
           <div class="weui_cell_hd"><label class="weui_label" style="width: 90px;">手机</label></div>
           <div class="weui_cell_bd weui_cell_primary">
               <input type="text" placeholder="请输入手机" value="${member.mobilePhone }" name="onlineBooking.mobilePhone" id="mobilePhone"  class="weui_input" checkType="mobilePhone" />
          </div>
       </div>
       <div class="weui_cell">
           <div class="weui_cell_hd" ><label class="weui_label" style="width: 90px;">预约时间</label></div>
           <div class="weui_cell_bd weui_cell_primary" >
               <input type="date" name="onlineBooking.bookingDate" id="bookingDate"  class="weui_input" checkType="dateComp,>"/>
          </div>
       </div>
</div>      
    <div class="weui_btn_area">
        <a class="weui_btn weui_btn_warn" href="javascript:" id="showTooltips" onclick="ajaxSubmit('${ctx}/onlineBookingWechat/saveOnlineBooking','frmId')">提交预约</a>
    </div>
    </form>
     <div id="toast" style="display: none;">
	    ...
	    <div class="weui_toast">
	        ...
	        <p class="weui_toast_content">数据提交成功</p>
	    </div>
	</div>
</body>
