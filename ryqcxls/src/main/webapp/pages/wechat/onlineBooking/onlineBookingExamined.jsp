...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 <meta charset="UTF-8">
    ...
    <script src="${ctx }/widgets/easyvalidator/js/easy_validator.pack5.js?d=1"></script>
    <style type="text/css">
    </style>
<title>续保年审</title>
</head>
...
<div class="title">
    ...
    <h3>${enterprise.name }续保年审在线预约</h3>
</div>
<br>
<br>
<br>
...
<form action="" id="frmId" name="frmId" method="post" target="_self">
	<input type="hidden" value="${param.wechat_id }" id="microId" name="onlineBookingExamined.microId">
  	<input type="hidden" value="3" id="bookingType" name="onlineBookingExamined.bookingType">
<div class="weui_cells weui_cells_form">
       ...
       <div class="weui_cell">
           ...
           <div class="weui_cell_bd weui_cell_primary">
               <input type="text"  placeholder="请输入联系人" value="${memberCarInfo.name  }" name="onlineBookingExamined.name" id="name" class="weui_input" checkType="string,1"/>
          </div>
       </div>
       <div class="weui_cell">
           <div class="weui_cell_hd"><label class="weui_label" style="width: 90px;">手机</label></div>
           <div class="weui_cell_bd weui_cell_primary">
               <input type="text" placeholder="请输入手机" value="${memberCarInfo.mobilePhone }" name="onlineBookingExamined.mobilePhone" id="mobilePhone"  class="weui_input" checkType="mobilePhone" />
          </div>
       </div>
       <div class="weui_cell">
           <div class="weui_cell_hd" ><label class="weui_label" style="width: 90px;">预约时间</label></div>
           <div class="weui_cell_bd weui_cell_primary" >
               <input type="date" name="onlineBookingExamined.bookingDate" id="bookingDate"  class="weui_input" checkType="dateComp,>"/>
          </div>
       </div>
       <div class="weui_cell">
           <div class="weui_cell_hd" ><label class="weui_label" style="width: 90px;">车牌号</label></div>
           <div class="weui_cell_bd weui_cell_primary" >
               <input type="text" placeholder="请输入车牌号" name="onlineBookingExamined.carPlate" id="carPlate"  class="weui_input" value="${memberCarInfo.carPlate }" checkType="string,1"/>
          </div>
       </div>
       <div class="weui_cell">
           <div class="weui_cell_hd" ><label class="weui_label" style="width: 90px;">上户日期</label></div>
           <div class="weui_cell_bd weui_cell_primary" >
               <input type="date" name="onlineBookingExamined.carPlateDate" id="carPlateDate" class="weui_input" />
          </div>
       </div>
       <div class="weui_cell">
           <div class="weui_cell_hd" ><label class="weui_label" style="width: 90px;">厂牌型号</label></div>
           <div class="weui_cell_bd weui_cell_primary" >
               <input  name="onlineBookingExamined.factoryModel" id="factoryModel" class="weui_input" />
          </div>
       </div>
       <div class="weui_cell">
           <div class="weui_cell_hd" ><label class="weui_label" style="width: 90px;">上牌时间</label></div>
           <div class="weui_cell_bd weui_cell_primary" >
               <input type="date" name="onlineBookingExamined.plateDate" id="plateDate" class="weui_input"  />
          </div>
       </div>
</div>      
    <div class="weui_btn_area">
        <a class="weui_btn weui_btn_warn" href="javascript:" id="showTooltips" onclick="ajaxSubmit('${ctx}/onlineBookingWechat/saveOnlineBookingEaxmined','frmId')">提交预约</a>
    </div>
    </form>
