...
<body >
  <div class="weui_cells_title" id="weui_cells_title">
   <a class="weui_btn weui_btn_mini weui_btn_plain_primary" href="javascript:;" onclick="submitHelp()" id="showDialog1" style="float: right;">确定取车地址</a>
...
<div class="container" id="container">
   ...
   <form action="" id="frmId" name="frmId" method="post">
   		<input type="hidden" value="12.12,12.012" id="coordinates" name="coordinates" >
   		<input type="hidden" value="成都市锦江区海椒市街36号成都市锦江区海椒市街36号" id="address1" name="address1">
   		<input type="hidden" value="钢五区" id="title" name="title">
   </form>
   <table request_url="http://apis.map.qq.com/ws/geocoder/v1/?" id="online_demo_01" style="display: none;">
    ...
    <div class="weui_dialog_confirm" id="dialog1" style="display: none;">
	    ...
	    <div class="weui_dialog">
	        <div class="weui_dialog_hd"><strong class="weui_dialog_title">确认取车地址</strong></div>
    ...
    // dialog
	    ...
	    function submitHelp(){
	    	...
	    	$("#weui_dialog_bd").text("");
	    	$("#weui_dialog_bd").append("您当前位于：“<span style='color:#04be02'>"+address+" "+titleValue+"</span>“,点击【确定】确认取车地址");
	    ...
	    function ajaxSubmit(url,frmId){
	    		...
	    		var params="point="+point+"&title="+title+"&address="+address1;
	    		params=encodeURI(encodeURI(params));
	    		var url="${ctx}/onlineBookingWechat/onlineBookingSM?serviceType=2&"+params;
