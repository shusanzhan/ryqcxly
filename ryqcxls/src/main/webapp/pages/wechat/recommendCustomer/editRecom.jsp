...
<input value="${recommendCustomer.dbid }" name="recommendCustomer.dbid" type="hidden" id="dbid">
<div class="weui_cells weui_cells_form">
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <input type="text" id="name" name="recommendCustomer.name"  value="${recommendCustomer.name }" placeholder="客户姓名"  class="weui_input" checkType="string,2">
            </div>
        </div>
         <div class="weui_cell">
            <div class="weui_cell_hd">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <input class="weui_input" id="mobilePhone" name="recommendCustomer.mobilePhone" value="${recommendCustomer.mobilePhone }" type="number" pattern="[0-9]*" placeholder="请输入号码" checkType="mobilePhone">
            </div>
        </div>
        <div class="weui_cell weui_cell_select weui_select_after">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <select class="weui_select" name="recommendCustomer.sex" id="sex">
                    <option value="男" ${recommendCustomer.sex=='男'?'selected="selected"':'' }> 先生</option>
                    <option value="女" ${recommendCustomer.sex=='女'?'selected="selected"':'' }>女士</option>
                </select>
            </div>
        </div>
        <div class="weui_cell weui_cell_select weui_select_after">
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <input class="weui_input" name="recommendCustomer.budgetMoney" id="budgetMoney" value="${recommendCustomer.budgetMoney }" type="number" pattern="[0-9]*" placeholder="请输入购车预算" checkType="float,10000">
            </div>
        </div>
   </div>    
    <div class="weui_btn_area">
        <a class="weui_btn weui_btn_warn" href="javascript:" id="showTooltips" onclick="ajaxSubmit('${ctx}/recommendCustomerWechat/saveEdit','frmId')">保存</a>
    </div>
