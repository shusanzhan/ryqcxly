					...
					<div class="widget-box">
						<div class="widget-content nopadding">
							<form class="form-horizontal" method="post" action="" 	name="frmId" id="frmId">
								...
								<c:if test="${empty(weixinAccount)||empty(weixinAccount.code)}" var="status">
								  <div class="control-group">
								...
								<div class="form-actions">
									<a href="javascript:void(-1)" class="btn btn-primary"	onclick="$.utile.submitForm('frmId','${ctx}/weixinAccount/saveEdit')">
