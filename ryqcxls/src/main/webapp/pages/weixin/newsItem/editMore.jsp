          ...
          <form id="appmsg-form" method="post" class="form" enctype="multipart/form-data">
	          ...
	          <div class="msg-content" style="width: 100%;">
		            ...
		            <div class="msg-item msg-input">
		                <input type="text" id="title" name="title" class="ui-input" value="${weixinNews.title }"/>
		            </div>
		            <label>作者<span class="help-inline">(选填)</span></label>
		            <div class="msg-item msg-input">
		                <input type="text" id="author" name="author" class="ui-input" value="${weixinNews.author }"/>
		            </div>
		            ...
		            <div id="url-block" style="display:none;">
		              ...
		              <div class="msg-item msg-input">
		                  <input id="from_url" type="text" class="ui-input" name="from_url" ${weixinNews.url }/>
		              </div>
		            </div>
		            </c:if>
		            <c:if test="${!empty(weixinNews.url) }">
		            <div id="url-block" >
		              <label>原文链接<span class="help-inline">(请输入正确的URL链接格式)</span></label>
		              <div class="msg-item msg-input">
		                  <input id="from_url" type="text" class="ui-input" name="from_url" value="${weixinNews.url }" />
		              </div>
		            </div>
		            </c:if>
