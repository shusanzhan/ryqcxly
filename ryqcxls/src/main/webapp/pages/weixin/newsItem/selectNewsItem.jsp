...
<body>
    ...
    <!-- 表格头部 -->
	    ...
	    <tr>
	        <th class="title">
	            <div class="td-cont">
	                <span>标题</span> <a class="js-update" href="javascript:void(0);" onclick="window.location.href='${ctx}/weixinNewsItem/selectNewsItem'">刷新</a>
	            </div>
	        </th>
	        ...
	        <th class="opts">
	            <div class="td-cont">
	                <form class="form-search" id="searchFrm" action="${ctx}/weixinNewsItem/selectNewsItem" method="post">
	    ...
	    <c:forEach var="weixinNewstemplate" items="${weixinNewstemplates }">
		            ...
		            <div class="ui-image-text">
		                <div class="ui-image-text-item">
		                    <span class="ui-image-text-label">图文</span>
		                     <a class="ui-image-text-title" href="javascript:void(-1)" target="_blank" title="${weixinNewstemplate.templatename }">
		                       ${weixinNewstemplate.templatename }
		                    </a>
		                </div>
		            </div>
		        </div>
		    ...
		    <td class="opts">
		        <div class="td-cont">
		            <a class="btn js-choose" href="javascript:void(-1)" data-id="49014339" data-url="" data-page-type="mpNews" data-cover-attachment-id="" data-cover-attachment-url="" data-title="小主语录" data-alias="" onclick="getTemplateId(${weixinNewstemplate.dbid})">选取</a>
		        </div>
		    </td>
		</tr>
	</c:forEach>
